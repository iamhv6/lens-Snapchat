...
//sampler sampler sc_RayTracingHitCasterIdAndBarycentricSmpSC 0:24
//sampler sampler sc_RayTracingRayDirectionSmpSC 0:25
//sampler sampler sc_ScreenTextureSmpSC 0:27
//texture texture2D intensityTexture 0:3:0:20
//texture texture2D sc_OITAlpha0 0:6:0:23
//texture texture2D sc_OITAlpha1 0:7:0:23
//texture texture2D sc_OITDepthHigh0 0:8:0:23
//texture texture2D sc_OITDepthHigh1 0:9:0:23
//texture texture2D sc_OITDepthLow0 0:10:0:23
//texture texture2D sc_OITDepthLow1 0:11:0:23
//texture texture2D sc_OITFilteredDepthBoundsTexture 0:12:0:23
//texture texture2D sc_OITFrontDepthTexture 0:13:0:23
//texture utexture2D sc_RayTracingHitCasterIdAndBarycentric 0:14:0:24
//texture texture2D sc_RayTracingRayDirection 0:15:0:25
//texture texture2D sc_ScreenTexture 0:17:0:27
//texture texture2DArray intensityTextureArrSC 0:30:0:20
//texture texture2DArray sc_ScreenTextureArrSC 0:34:0:27
...
//spec_const bool sc_RayTracingCasterForceOpaque 65 0
...
if (l9_0)
{
if (sc_RayTracingEvaluateHitPayload(ivec2(gl_FragCoord.xy)).id.x!=(sc_RayTracingCasterConfiguration.y&65535u))
{
return;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_1,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_3;
...
{
l9_5=clamp(baseColor.w*2.0,0.0,1.0);
}
#else
{
float l9_6;
...
{
l9_6=clamp(dot(baseColor.xyz,vec3(baseColor.w)),0.0,1.0);
}
#else
{
float l9_7;
...
{
l9_8=(1.0-dot(baseColor.xyz,vec3(0.33333001)))*baseColor.w;
}
#else
{
float l9_9;
...
{
l9_9=(1.0-clamp(dot(baseColor.xyz,vec3(1.0)),0.0,1.0))*baseColor.w;
}
#else
{
float l9_10;
...
{
l9_10=clamp(dot(baseColor.xyz,vec3(1.0)),0.0,1.0)*baseColor.w;
}
#else
{
float l9_11;
#if (sc_BlendMode_Add)
{
l9_11=clamp(dot(baseColor.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_12;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_12=clamp(dot(baseColor.xyz,vec3(1.0)),0.0,1.0)*baseColor.w;
}
#else
{
float l9_13;
...
{
l9_13=dot(baseColor.xyz,vec3(0.33333001))*baseColor.w;
}
#else
{
float l9_14;
#if (sc_BlendMode_Min)
{
l9_14=1.0-clamp(dot(baseColor.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_15;
#if (sc_BlendMode_Max)
{
l9_15=clamp(dot(baseColor.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_15=1.0;
...
#endif
l9_3=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*baseColor.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_4);
}
#else
{
vec4 l9_16;
...
#if (sc_FramebufferFetch)
{
l9_18=sc_readFragData0_Platform();
}
#else
{
...
{
l9_20=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_19,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_20=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_19,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_18=l9_20;
}
#endif
vec3 l9_21=mix(l9_18.xyz,definedBlend(l9_18.xyz,baseColor.xyz).xyz,vec3(baseColor.w));
...
#if (sc_Voxelization)
{
l9_23=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_24;
#if (sc_OutputBounds)
{
float l9_25=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_24=vec4(l9_25,1.0-l9_25,1.0,1.0);
}
#else
{
vec4 l9_26;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_26=vec4(mix(vec3(1.0),baseColor.xyz,vec3(baseColor.w)),baseColor.w);
}
#else
{
vec4 l9_27;
...
{
l9_28=clamp(baseColor.w,0.0,1.0);
}
#else
{
l9_28=baseColor.w;
...
#endif
l9_27=vec4(baseColor.xyz*l9_28,l9_28);
}
#else
{
l9_27=baseColor;
...
vec4 l9_31=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_29,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_33-0.0039215689)),min(1.0,l9_33+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_35),packValue(l9_35),packValue(l9_35),packValue(l9_35)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
sc_writeFragData0Internal(l9_77,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_32,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_31,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
