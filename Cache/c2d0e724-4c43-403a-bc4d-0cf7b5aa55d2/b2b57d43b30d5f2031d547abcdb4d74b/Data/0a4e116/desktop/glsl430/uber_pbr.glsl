...
//texture texture2D sc_RayTracingReflections 0:26:0:48
...
//texture texture2DArray sc_RayTracingReflectionsArrSC 0:68:0:48
...
//spec_const bool sc_BlendMode_AddWithAlphaFactor 88 0
...
//spec_const bool sc_BlendMode_MultiplyOriginal 96 0
//spec_const bool sc_BlendMode_Normal 97 0
//spec_const bool sc_BlendMode_PremultipliedAlpha 98 0
//spec_const bool sc_BlendMode_PremultipliedAlphaAuto 99 0
//spec_const bool sc_BlendMode_PremultipliedAlphaHardware 100 0
...
//spec_const bool sc_OITDepthPrepass 113 0
//spec_const bool sc_OITFrontLayerPass 114 0
//spec_const bool sc_OITMaxLayers4Plus1 115 0
//spec_const bool sc_OITMaxLayers8 116 0
//spec_const bool sc_OITMaxLayersVisualizeLayerCount 117 0
//spec_const bool sc_OutputBounds 118 0
//spec_const bool sc_ProjectiveShadowsCaster 119 0
//spec_const bool sc_ProjectiveShadowsReceiver 120 0
//spec_const bool sc_RayTracingCasterForceOpaque 121 0
//spec_const bool sc_RayTracingGlobalIlluminationHasSwappedViews 122 0
//spec_const bool sc_RayTracingReflectionsHasSwappedViews 123 0
//spec_const bool sc_RayTracingShadowsHasSwappedViews 124 0
//spec_const bool sc_RenderAlphaToColor 125 0
//spec_const bool sc_SSAOEnabled 126 0
//spec_const bool sc_ScreenTextureHasSwappedViews 127 0
//spec_const bool sc_TAAEnabled 128 0
//spec_const bool sc_VertexBlending 129 0
//spec_const bool sc_VertexBlendingUseNormals 130 0
//spec_const bool sc_Voxelization 131 0
//spec_const bool uv2EnableAnimation 132 0
//spec_const bool uv3EnableAnimation 133 0
//spec_const int NODE_13_DROPLIST_ITEM 134 0
//spec_const int NODE_181_DROPLIST_ITEM 135 0
//spec_const int NODE_184_DROPLIST_ITEM 136 0
//spec_const int NODE_221_DROPLIST_ITEM 137 0
//spec_const int NODE_228_DROPLIST_ITEM 138 0
//spec_const int NODE_27_DROPLIST_ITEM 139 0
//spec_const int NODE_315_DROPLIST_ITEM 140 0
//spec_const int NODE_38_DROPLIST_ITEM 141 0
//spec_const int NODE_49_DROPLIST_ITEM 142 0
//spec_const int NODE_69_DROPLIST_ITEM 143 0
//spec_const int NODE_76_DROPLIST_ITEM 144 0
//spec_const int SC_DEVICE_CLASS 145 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 146 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_detailNormalTex 147 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_emissiveTex 148 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 149 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_materialParamsTex 150 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_normalTex 151 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 152 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex 153 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_reflectionTex 154 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_rimColorTex 155 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 156 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_detailNormalTex 157 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_emissiveTex 158 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 159 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_materialParamsTex 160 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_normalTex 161 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 162 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex 163 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_reflectionTex 164 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_rimColorTex 165 -1
//spec_const int baseTexLayout 166 0
//spec_const int detailNormalTexLayout 167 0
//spec_const int emissiveTexLayout 168 0
//spec_const int intensityTextureLayout 169 0
//spec_const int materialParamsTexLayout 170 0
//spec_const int normalTexLayout 171 0
//spec_const int opacityTexLayout 172 0
//spec_const int reflectionModulationTexLayout 173 0
//spec_const int reflectionTexLayout 174 0
//spec_const int rimColorTexLayout 175 0
//spec_const int sc_AmbientLightMode0 176 0
//spec_const int sc_AmbientLightMode1 177 0
//spec_const int sc_AmbientLightMode2 178 0
//spec_const int sc_AmbientLightMode_Constant 179 0
//spec_const int sc_AmbientLightMode_EnvironmentMap 180 0
//spec_const int sc_AmbientLightMode_FromCamera 181 0
//spec_const int sc_AmbientLightMode_SphericalHarmonics 182 0
//spec_const int sc_AmbientLightsCount 183 0
//spec_const int sc_DepthBufferMode 184 0
//spec_const int sc_DirectionalLightsCount 185 0
//spec_const int sc_EnvLightMode 186 0
//spec_const int sc_EnvmapDiffuseLayout 187 0
//spec_const int sc_EnvmapSpecularLayout 188 0
//spec_const int sc_LightEstimationSGCount 189 0
//spec_const int sc_PointLightsCount 190 0
//spec_const int sc_RayTracingGlobalIlluminationLayout 191 0
//spec_const int sc_RayTracingReflectionsLayout 192 0
//spec_const int sc_RayTracingShadowsLayout 193 0
...
#endif
tempGlobals=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec2(0.0),vec2(0.0),vec3(0.0),normalize(sc_Camera.position-varPos),varPos,l9_0,l9_1,cross(l9_0,l9_1)*varTangent.w,varPackedTex.xy,varPackedTex.zw,varColor,l9_3,varPos);
...
{
vec2 l9_437=N7_getUV(NODE_221_DROPLIST_ITEM);
vec4 l9_438;
#if (materialParamsTexLayout==2)
{
bool l9_439=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_440=l9_437.x;
sc_SoftwareWrapEarly(l9_440,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_441=l9_440;
float l9_442=l9_437.y;
sc_SoftwareWrapEarly(l9_442,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_443=l9_442;
vec2 l9_444;
float l9_445;
...
{
l9_446=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_446=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_447=l9_441;
float l9_448=1.0;
sc_ClampUV(l9_447,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_446,l9_448);
float l9_449=l9_447;
float l9_450=l9_448;
bool l9_451;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_451=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_451=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_452=l9_443;
float l9_453=l9_450;
sc_ClampUV(l9_452,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_451,l9_453);
l9_445=l9_453;
l9_444=vec2(l9_449,l9_452);
}
#else
{
l9_445=1.0;
l9_444=vec2(l9_441,l9_443);
}
#endif
vec2 l9_454=sc_TransformUV(l9_444,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_455=l9_454.x;
float l9_456=l9_445;
sc_SoftwareWrapLate(l9_455,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_439,l9_456);
float l9_457=l9_454.y;
float l9_458=l9_456;
sc_SoftwareWrapLate(l9_457,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_439,l9_458);
float l9_459=l9_458;
vec3 l9_460=sc_SamplingCoordsViewToGlobal(vec2(l9_455,l9_457),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_461=texture(materialParamsTexArrSC,l9_460,0.0);
vec4 l9_462;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_462=mix(materialParamsTexBorderColor,l9_461,vec4(l9_459));
}
#else
{
l9_462=l9_461;
...
#else
{
bool l9_463=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_464=l9_437.x;
sc_SoftwareWrapEarly(l9_464,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_465=l9_464;
float l9_466=l9_437.y;
sc_SoftwareWrapEarly(l9_466,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_467=l9_466;
vec2 l9_468;
float l9_469;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_470=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_470=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_471=l9_465;
float l9_472=1.0;
sc_ClampUV(l9_471,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_470,l9_472);
float l9_473=l9_471;
float l9_474=l9_472;
bool l9_475;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_475=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_475=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_476=l9_467;
float l9_477=l9_474;
sc_ClampUV(l9_476,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_475,l9_477);
l9_469=l9_477;
...
#endif
vec2 l9_478=sc_TransformUV(l9_468,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_479=l9_478.x;
float l9_480=l9_469;
sc_SoftwareWrapLate(l9_479,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_463,l9_480);
float l9_481=l9_478.y;
float l9_482=l9_480;
sc_SoftwareWrapLate(l9_481,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_463,l9_482);
float l9_483=l9_482;
vec3 l9_484=sc_SamplingCoordsViewToGlobal(vec2(l9_479,l9_481),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_485=texture(materialParamsTex,l9_484.xy,0.0);
vec4 l9_486;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_486=mix(materialParamsTexBorderColor,l9_485,vec4(l9_483));
}
#else
{
l9_486=l9_485;
...
#endif
float l9_488=clamp(l9_109,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_488<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_488<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
uvec3 l9_489=uvec3(round((varPos-sc_RayTracingOriginOffset)*sc_RayTracingOriginScale));
sc_RayTracingPositionAndMask=uvec4(l9_489.x,l9_489.y,l9_489.z,sc_RayTracingPositionAndMask.w);
sc_RayTracingPositionAndMask.w=sc_RayTracingReceiverMask;
vec3 l9_490=l9_487/vec3(dot(abs(l9_487),vec3(1.0)));
vec2 l9_491=vec2(clamp(-l9_490.z,0.0,1.0));
vec2 l9_492=l9_490.xy;
uint l9_493=packHalf2x16(l9_492+mix(-l9_491,l9_491,step(vec2(0.0),l9_492)));
uvec2 l9_494=uvec2(l9_493&65535u,l9_493>>16u);
sc_RayTracingNormalAndMore=uvec4(l9_494.x,l9_494.y,sc_RayTracingNormalAndMore.z,sc_RayTracingNormalAndMore.w);
sc_RayTracingNormalAndMore.z=0u;
sc_RayTracingNormalAndMore.w=uint(clamp(l9_436,0.0,1.0)*1000.0)|((sc_RayTracingReceiverId%32u)<<10u);
}
...
l9_9=normalize(sc_Camera.position-varPos);
l9_8=varPos;
l9_7=l9_16;
l9_6=l9_17;
l9_5=cross(l9_16,l9_17)*varTangent.w;
l9_4=varPackedTex.xy;
l9_3=varPackedTex.zw;
l9_2=varColor;
...
#if (ENABLE_MATERIAL_PARAM_TEX)
{
vec2 l9_456=N7_getUV(NODE_221_DROPLIST_ITEM);
vec4 l9_457;
#if (materialParamsTexLayout==2)
{
bool l9_458=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_459=l9_456.x;
sc_SoftwareWrapEarly(l9_459,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_460=l9_459;
float l9_461=l9_456.y;
sc_SoftwareWrapEarly(l9_461,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_462=l9_461;
vec2 l9_463;
float l9_464;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_465=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_465=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_466=l9_460;
float l9_467=1.0;
sc_ClampUV(l9_466,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_465,l9_467);
float l9_468=l9_466;
float l9_469=l9_467;
bool l9_470;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_470=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_470=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
...
float l9_471=l9_462;
float l9_472=l9_469;
sc_ClampUV(l9_471,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_470,l9_472);
l9_464=l9_472;
...
#endif
vec2 l9_473=sc_TransformUV(l9_463,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_474=l9_473.x;
float l9_475=l9_464;
sc_SoftwareWrapLate(l9_474,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_458,l9_475);
float l9_476=l9_473.y;
float l9_477=l9_475;
sc_SoftwareWrapLate(l9_476,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_458,l9_477);
float l9_478=l9_477;
vec3 l9_479=sc_SamplingCoordsViewToGlobal(vec2(l9_474,l9_476),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_480=texture(materialParamsTexArrSC,l9_479,0.0);
vec4 l9_481;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_481=mix(materialParamsTexBorderColor,l9_480,vec4(l9_478));
}
#else
{
l9_481=l9_480;
...
#else
{
bool l9_482=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_483=l9_456.x;
sc_SoftwareWrapEarly(l9_483,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_484=l9_483;
float l9_485=l9_456.y;
sc_SoftwareWrapEarly(l9_485,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_486=l9_485;
vec2 l9_487;
float l9_488;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_489=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_489=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_490=l9_484;
float l9_491=1.0;
sc_ClampUV(l9_490,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_489,l9_491);
float l9_492=l9_490;
float l9_493=l9_491;
bool l9_494;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_494=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_494=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_495=l9_486;
float l9_496=l9_493;
sc_ClampUV(l9_495,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_494,l9_496);
l9_488=l9_496;
l9_487=vec2(l9_492,l9_495);
}
#else
{
l9_488=1.0;
l9_487=vec2(l9_484,l9_486);
}
#endif
vec2 l9_497=sc_TransformUV(l9_487,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_498=l9_497.x;
float l9_499=l9_488;
sc_SoftwareWrapLate(l9_498,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_482,l9_499);
float l9_500=l9_497.y;
float l9_501=l9_499;
sc_SoftwareWrapLate(l9_500,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_482,l9_501);
float l9_502=l9_501;
vec3 l9_503=sc_SamplingCoordsViewToGlobal(vec2(l9_498,l9_500),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_504=texture(materialParamsTex,l9_503.xy,0.0);
vec4 l9_505;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_505=mix(materialParamsTexBorderColor,l9_504,vec4(l9_502));
}
#else
{
l9_505=l9_504;
...
#endif
l9_455=roughness*l9_457.y;
l9_454=l9_452*l9_457.z;
l9_453=metallic*l9_457.x;
}
#else
{
l9_455=roughness;
...
{
vec3 l9_507=mix(vec3(0.039999999),l9_123.xyz*l9_453,vec3(l9_453));
l9_506=mix(vec3(1.0),mix((l9_507*(1.0-specularAoDarkening))*l9_507,vec3(1.0),vec3(l9_454.x)),vec3(specularAoIntensity));
}
#else
{
l9_506=vec3(1.0);
...
#endif
float l9_510=clamp(l9_124,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_510<alphaTestThreshold)
{
discard;
}
}
...
#if (ENABLE_STIPPLE_PATTERN_TEST)
{
if (l9_510<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_511=max(l9_123.xyz,vec3(0.0));
vec4 l9_512;
#if (sc_ProjectiveShadowsCaster)
{
l9_512=vec4(l9_511,l9_510);
}
#else
{
l9_512=ngsCalculateLighting(l9_511,l9_510,l9_509,l9_8,l9_9,max(l9_451,vec3(0.0)),clamp(l9_453,0.0,1.0),clamp(l9_455,0.0,1.0),clamp(l9_454,vec3(0.0),vec3(1.0)),clamp(l9_508,vec3(0.0),vec3(1.0)));
}
#endif
vec4 l9_513=max(l9_512,vec4(0.0));
if (l9_0)
{
vec4 l9_514;
...
#endif
sc_writeFragData0Internal(max(l9_514,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_516;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_518=clamp(l9_513.w*2.0,0.0,1.0);
}
#else
{
float l9_519;
...
{
l9_519=clamp(dot(l9_513.xyz,vec3(l9_513.w)),0.0,1.0);
}
#else
{
float l9_520;
...
#if (sc_BlendMode_Multiply)
{
l9_521=(1.0-dot(l9_513.xyz,vec3(0.33333001)))*l9_513.w;
}
#else
{
float l9_522;
...
{
l9_522=(1.0-clamp(dot(l9_513.xyz,vec3(1.0)),0.0,1.0))*l9_513.w;
}
#else
{
float l9_523;
#if (sc_BlendMode_ColoredGlass)
{
l9_523=clamp(dot(l9_513.xyz,vec3(1.0)),0.0,1.0)*l9_513.w;
}
#else
{
float l9_524;
#if (sc_BlendMode_Add)
{
l9_524=clamp(dot(l9_513.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_525;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_525=clamp(dot(l9_513.xyz,vec3(1.0)),0.0,1.0)*l9_513.w;
}
#else
{
float l9_526;
...
{
l9_526=dot(l9_513.xyz,vec3(0.33333001))*l9_513.w;
}
#else
{
float l9_527;
#if (sc_BlendMode_Min)
{
l9_527=1.0-clamp(dot(l9_513.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_528;
#if (sc_BlendMode_Max)
{
l9_528=clamp(dot(l9_513.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_528=1.0;
...
#endif
l9_516=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_513.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_517);
}
#else
{
vec4 l9_529;
...
{
vec3 l9_531=sc_GetFramebufferColor().xyz;
vec3 l9_532=mix(l9_531,definedBlend(l9_531,l9_513.xyz).xyz,vec3(l9_513.w));
vec4 l9_533=vec4(l9_532.x,l9_532.y,l9_532.z,vec4(0.0).w);
l9_533.w=1.0;
l9_530=l9_533;
}
#else
...
#if (sc_Voxelization)
{
l9_534=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_535;
#if (sc_OutputBounds)
{
float l9_536=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_535=vec4(l9_536,1.0-l9_536,1.0,1.0);
}
#else
{
vec4 l9_537;
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_538=l9_513.w;
l9_537=vec4(mix(vec3(1.0),l9_513.xyz,vec3(l9_538)),l9_538);
}
#else
{
vec4 l9_539;
...
{
float l9_540=l9_513.w;
float l9_541;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_541=clamp(l9_540,0.0,1.0);
}
#else
{
l9_541=l9_540;
...
#endif
l9_539=vec4(l9_513.xyz*l9_541,l9_541);
}
#else
{
l9_539=l9_513;
...
vec4 l9_544=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_542,vec4(0.0)));
vec4 l9_545=clamp(l9_544,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_546=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_546-0.0039215689)),min(1.0,l9_546+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_547=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_547).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_548=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_547).xy);
float l9_549=packValue(l9_548);
int l9_556=int(l9_545.w*255.0);
float l9_557=packValue(l9_556);
sc_writeFragData0Internal(vec4(packValue(l9_548),packValue(l9_548),packValue(l9_548),packValue(l9_548)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_549,packValue(l9_548),packValue(l9_548),packValue(l9_548)));
sc_writeFragData2(vec4(l9_557,packValue(l9_556),packValue(l9_556),packValue(l9_556)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_560=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_560).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_565==0)
{
l9_568=texture(sc_OITAlpha0,l9_560);
l9_567=texture(sc_OITDepthLow0,l9_560);
l9_566=texture(sc_OITDepthHigh0,l9_560);
}
else
{
l9_568=vec4(0.0);
...
if (l9_565==1)
{
l9_571=texture(sc_OITAlpha1,l9_560);
l9_570=texture(sc_OITDepthLow1,l9_560);
l9_569=texture(sc_OITDepthHigh1,l9_560);
}
else
{
l9_571=l9_568;
...
if (any(notEqual(l9_569,vec4(0.0)))||any(notEqual(l9_570,vec4(0.0))))
{
int l9_572[8]=l9_561;
unpackValues(l9_569.w,l9_565,l9_572);
unpackValues(l9_569.z,l9_565,l9_572);
unpackValues(l9_569.y,l9_565,l9_572);
unpackValues(l9_569.x,l9_565,l9_572);
unpackValues(l9_570.w,l9_565,l9_572);
unpackValues(l9_570.z,l9_565,l9_572);
unpackValues(l9_570.y,l9_565,l9_572);
unpackValues(l9_570.x,l9_565,l9_572);
int l9_581[8]=l9_562;
unpackValues(l9_571.w,l9_565,l9_581);
unpackValues(l9_571.z,l9_565,l9_581);
unpackValues(l9_571.y,l9_565,l9_581);
unpackValues(l9_571.x,l9_565,l9_581);
}
l9_565++;
continue;
}
...
vec4 l9_586=texture(sc_OITFilteredDepthBoundsTexture,l9_560);
vec2 l9_587=l9_586.xy;
int l9_588;
#if (sc_SkinBonesCount>0)
{
l9_588=encodeDepth(((1.0-l9_586.x)*1000.0)+getDepthOrderingEpsilon(),l9_587);
}
#else
{
l9_588=0;
...
#endif
int l9_589=encodeDepth(viewSpaceDepth(),l9_587);
vec4 l9_590;
l9_590=l9_545*l9_545.w;
vec4 l9_591;
int l9_592=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_592<8)
{
int l9_593=l9_561[l9_592];
int l9_594=l9_589-l9_588;
bool l9_595=l9_593<l9_594;
bool l9_596;
if (l9_595)
{
l9_596=l9_561[l9_592]>0;
}
else
{
l9_596=l9_595;
...
if (l9_596)
{
vec3 l9_597=l9_590.xyz*(1.0-(float(l9_562[l9_592])/255.0));
l9_591=vec4(l9_597.x,l9_597.y,l9_597.z,l9_590.w);
}
else
{
l9_591=l9_590;
...
sc_writeFragData0Internal(l9_590,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_545,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_544,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
