...
//sampler sampler opacityTexSmpSC 0:26
...
//texture texture2D emissiveTex 0:4:0:24
//texture texture2D intensityTexture 0:5:0:25
//texture texture2D opacityTex 0:6:0:26
...
//texture texture2DArray emissiveTexArrSC 0:37:0:24
//texture texture2DArray intensityTextureArrSC 0:38:0:25
//texture texture2DArray opacityTexArrSC 0:39:0:26
...
//spec_const bool ENABLE_OPACITY_TEX 32 0
//spec_const bool ENABLE_RECOLOR 33 0
//spec_const bool ENABLE_STIPPLE_PATTERN_TEST 34 0
//spec_const bool ENABLE_UV2 35 0
//spec_const bool ENABLE_UV3 36 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_baseTex 37 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_emissiveTex 38 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 39 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_opacityTex 40 0
//spec_const bool SC_USE_UV_MIN_MAX_baseTex 41 0
//spec_const bool SC_USE_UV_MIN_MAX_emissiveTex 42 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 43 0
//spec_const bool SC_USE_UV_MIN_MAX_opacityTex 44 0
//spec_const bool SC_USE_UV_TRANSFORM_baseTex 45 0
//spec_const bool SC_USE_UV_TRANSFORM_emissiveTex 46 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 47 0
//spec_const bool SC_USE_UV_TRANSFORM_opacityTex 48 0
//spec_const bool UseViewSpaceDepthVariant 49 1
//spec_const bool baseTexHasSwappedViews 50 0
//spec_const bool emissiveTexHasSwappedViews 51 0
...
//spec_const bool sc_DepthOnly 69 0
...
//spec_const bool sc_RayTracingCasterForceOpaque 83 0
//spec_const bool sc_RenderAlphaToColor 84 0
//spec_const bool sc_ScreenTextureHasSwappedViews 85 0
//spec_const bool sc_TAAEnabled 86 0
//spec_const bool sc_VertexBlending 87 0
//spec_const bool sc_VertexBlendingUseNormals 88 0
//spec_const bool sc_Voxelization 89 0
//spec_const bool uv2EnableAnimation 90 0
//spec_const bool uv3EnableAnimation 91 0
//spec_const int NODE_13_DROPLIST_ITEM 92 0
//spec_const int NODE_27_DROPLIST_ITEM 93 0
//spec_const int NODE_38_DROPLIST_ITEM 94 0
//spec_const int NODE_49_DROPLIST_ITEM 95 0
//spec_const int NODE_69_DROPLIST_ITEM 96 0
//spec_const int NODE_76_DROPLIST_ITEM 97 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 98 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_emissiveTex 99 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 100 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 101 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 102 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_emissiveTex 103 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 104 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 105 -1
//spec_const int baseTexLayout 106 0
//spec_const int emissiveTexLayout 107 0
//spec_const int intensityTextureLayout 108 0
//spec_const int opacityTexLayout 109 0
...
//spec_const int sc_StereoViewID 117 0
//SG_REFLECTION_END
...
l9_3=l9_5.uv1;
l9_2=l9_5.color;
l9_1=((l9_6.xy/vec2(l9_6.w))*0.5)+vec2(0.5);
}
else
{
...
tempGlobals=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec2(0.0),vec2(0.0),l9_4,l9_3,l9_2,l9_1);
...
#if (baseTexLayout==2)
{
bool l9_10=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_11=l9_8.x;
sc_SoftwareWrapEarly(l9_11,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_12=l9_11;
float l9_13=l9_8.y;
sc_SoftwareWrapEarly(l9_13,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_14=l9_13;
vec2 l9_15;
float l9_16;
...
{
l9_17=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
...
float l9_18=l9_12;
float l9_19=1.0;
sc_ClampUV(l9_18,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_17,l9_19);
float l9_20=l9_18;
float l9_21=l9_19;
bool l9_22;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_22=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
...
float l9_23=l9_14;
float l9_24=l9_21;
sc_ClampUV(l9_23,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_22,l9_24);
l9_16=l9_24;
l9_15=vec2(l9_20,l9_23);
}
#else
{
l9_16=1.0;
l9_15=vec2(l9_12,l9_14);
}
#endif
vec2 l9_25=sc_TransformUV(l9_15,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_26=l9_25.x;
float l9_27=l9_16;
sc_SoftwareWrapLate(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_10,l9_27);
float l9_28=l9_25.y;
float l9_29=l9_27;
sc_SoftwareWrapLate(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_10,l9_29);
float l9_30=l9_29;
vec3 l9_31=sc_SamplingCoordsViewToGlobal(vec2(l9_26,l9_28),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_32=texture(baseTexArrSC,l9_31,0.0);
vec4 l9_33;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_33=mix(baseTexBorderColor,l9_32,vec4(l9_30));
}
#else
{
l9_33=l9_32;
...
#else
{
bool l9_34=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_35=l9_8.x;
...
float l9_50=l9_49.x;
float l9_51=l9_40;
sc_SoftwareWrapLate(l9_50,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_34,l9_51);
float l9_52=l9_49.y;
float l9_53=l9_51;
sc_SoftwareWrapLate(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_34,l9_53);
float l9_54=l9_53;
...
#if (ENABLE_RECOLOR)
{
vec3 l9_59=((recolorRed*l9_7.x)+(recolorGreen*l9_7.y))+(recolorBlue*l9_7.z);
l9_58=vec4(l9_59.x,l9_59.y,l9_59.z,l9_7.w);
}
#else
{
l9_58=l9_7;
...
{
vec2 l9_61=N7_getUV(NODE_69_DROPLIST_ITEM);
vec4 l9_62;
#if (opacityTexLayout==2)
{
bool l9_63=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_64=l9_61.x;
sc_SoftwareWrapEarly(l9_64,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_65=l9_64;
float l9_66=l9_61.y;
sc_SoftwareWrapEarly(l9_66,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_67=l9_66;
vec2 l9_68;
float l9_69;
...
{
l9_70=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_70=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_71=l9_65;
float l9_72=1.0;
sc_ClampUV(l9_71,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_70,l9_72);
float l9_73=l9_71;
float l9_74=l9_72;
bool l9_75;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_75=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_75=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_76=l9_67;
float l9_77=l9_74;
sc_ClampUV(l9_76,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_75,l9_77);
l9_69=l9_77;
...
#endif
vec2 l9_78=sc_TransformUV(l9_68,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_79=l9_78.x;
float l9_80=l9_69;
sc_SoftwareWrapLate(l9_79,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_63,l9_80);
float l9_81=l9_78.y;
float l9_82=l9_80;
sc_SoftwareWrapLate(l9_81,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_63,l9_82);
float l9_83=l9_82;
vec3 l9_84=sc_SamplingCoordsViewToGlobal(vec2(l9_79,l9_81),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_85=texture(opacityTexArrSC,l9_84,0.0);
vec4 l9_86;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_86=mix(opacityTexBorderColor,l9_85,vec4(l9_83));
}
#else
{
l9_86=l9_85;
...
#else
{
bool l9_87=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_88=l9_61.x;
sc_SoftwareWrapEarly(l9_88,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_89=l9_88;
float l9_90=l9_61.y;
sc_SoftwareWrapEarly(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_91=l9_90;
vec2 l9_92;
float l9_93;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_94=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_94=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_95=l9_89;
float l9_96=1.0;
sc_ClampUV(l9_95,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_94,l9_96);
float l9_97=l9_95;
float l9_98=l9_96;
bool l9_99;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_99=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_99=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_100=l9_91;
float l9_101=l9_98;
sc_ClampUV(l9_100,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_99,l9_101);
l9_93=l9_101;
...
#endif
vec2 l9_102=sc_TransformUV(l9_92,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_103=l9_102.x;
float l9_104=l9_93;
sc_SoftwareWrapLate(l9_103,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_87,l9_104);
float l9_105=l9_102.y;
float l9_106=l9_104;
sc_SoftwareWrapLate(l9_105,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_87,l9_106);
float l9_107=l9_106;
vec3 l9_108=sc_SamplingCoordsViewToGlobal(vec2(l9_103,l9_105),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_109=texture(opacityTex,l9_108.xy,0.0);
vec4 l9_110;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_110=mix(opacityTexBorderColor,l9_109,vec4(l9_107));
}
#else
{
l9_110=l9_109;
...
#endif
float l9_111=l9_60*l9_58.w;
vec4 l9_112;
float l9_113;
if (NODE_38_DROPLIST_ITEM==1)
{
l9_113=l9_111*tempGlobals.VertexColor.w;
l9_112=l9_58*tempGlobals.VertexColor;
}
else
{
l9_113=l9_111;
...
#if (ENABLE_EMISSIVE)
{
vec2 l9_115=N7_getUV(NODE_76_DROPLIST_ITEM);
vec4 l9_116;
#if (emissiveTexLayout==2)
{
bool l9_117=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0));
float l9_118=l9_115.x;
sc_SoftwareWrapEarly(l9_118,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x);
float l9_119=l9_118;
float l9_120=l9_115.y;
sc_SoftwareWrapEarly(l9_120,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y);
float l9_121=l9_120;
vec2 l9_122;
float l9_123;
...
{
l9_124=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x==3;
}
#else
{
l9_124=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0);
}
#endif
float l9_125=l9_119;
float l9_126=1.0;
sc_ClampUV(l9_125,emissiveTexUvMinMax.x,emissiveTexUvMinMax.z,l9_124,l9_126);
float l9_127=l9_125;
float l9_128=l9_126;
bool l9_129;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_129=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y==3;
}
#else
{
...
float l9_130=l9_121;
float l9_131=l9_128;
sc_ClampUV(l9_130,emissiveTexUvMinMax.y,emissiveTexUvMinMax.w,l9_129,l9_131);
l9_123=l9_131;
...
#endif
vec2 l9_132=sc_TransformUV(l9_122,(int(SC_USE_UV_TRANSFORM_emissiveTex)!=0),emissiveTexTransform);
float l9_133=l9_132.x;
float l9_134=l9_123;
sc_SoftwareWrapLate(l9_133,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x,l9_117,l9_134);
float l9_135=l9_132.y;
float l9_136=l9_134;
sc_SoftwareWrapLate(l9_135,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y,l9_117,l9_136);
float l9_137=l9_136;
vec3 l9_138=sc_SamplingCoordsViewToGlobal(vec2(l9_133,l9_135),emissiveTexLayout,emissiveTexGetStereoViewIndex());
vec4 l9_139=texture(emissiveTexArrSC,l9_138,0.0);
vec4 l9_140;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_140=mix(emissiveTexBorderColor,l9_139,vec4(l9_137));
}
#else
{
l9_140=l9_139;
...
#else
{
bool l9_141=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0));
float l9_142=l9_115.x;
sc_SoftwareWrapEarly(l9_142,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x);
float l9_143=l9_142;
float l9_144=l9_115.y;
sc_SoftwareWrapEarly(l9_144,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y);
float l9_145=l9_144;
vec2 l9_146;
float l9_147;
#if (SC_USE_UV_MIN_MAX_emissiveTex)
...
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_148=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x==3;
}
#else
{
l9_148=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0);
}
#endif
float l9_149=l9_143;
float l9_150=1.0;
sc_ClampUV(l9_149,emissiveTexUvMinMax.x,emissiveTexUvMinMax.z,l9_148,l9_150);
float l9_151=l9_149;
float l9_152=l9_150;
bool l9_153;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_153=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y==3;
}
#else
{
l9_153=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0);
}
#endif
float l9_154=l9_145;
float l9_155=l9_152;
sc_ClampUV(l9_154,emissiveTexUvMinMax.y,emissiveTexUvMinMax.w,l9_153,l9_155);
l9_147=l9_155;
...
#endif
vec2 l9_156=sc_TransformUV(l9_146,(int(SC_USE_UV_TRANSFORM_emissiveTex)!=0),emissiveTexTransform);
float l9_157=l9_156.x;
float l9_158=l9_147;
sc_SoftwareWrapLate(l9_157,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x,l9_141,l9_158);
float l9_159=l9_156.y;
float l9_160=l9_158;
sc_SoftwareWrapLate(l9_159,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y,l9_141,l9_160);
float l9_161=l9_160;
vec3 l9_162=sc_SamplingCoordsViewToGlobal(vec2(l9_157,l9_159),emissiveTexLayout,emissiveTexGetStereoViewIndex());
vec4 l9_163=texture(emissiveTex,l9_162.xy,0.0);
vec4 l9_164;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_164=mix(emissiveTexBorderColor,l9_163,vec4(l9_161));
}
#else
{
l9_164=l9_163;
...
#endif
bool l9_165=NODE_38_DROPLIST_ITEM==2;
vec3 l9_166;
if (l9_165)
{
l9_166=l9_114+tempGlobals.VertexColor.xyz;
}
else
{
l9_166=l9_114;
...
vec3 l9_167;
if (l9_165||(int(ENABLE_EMISSIVE)!=0))
{
l9_167=ssPow((l9_166*emissiveColor)*vec3(emissiveIntensity),vec3(2.2));
}
else
{
l9_167=l9_166;
}
vec3 l9_168=l9_112.xyz+ssPow((l9_167+vec3(0.0))+vec3(0.0),vec3(0.45454547));
vec4 l9_169=vec4(l9_168.x,l9_168.y,l9_168.z,vec4(0.0).w);
l9_169.w=l9_113;
...
#endif
sc_writeFragData0Internal(max(l9_170,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_172;
...
{
l9_174=clamp(l9_113*2.0,0.0,1.0);
}
#else
{
float l9_175;
...
{
l9_175=clamp(dot(l9_169.xyz,vec3(l9_113)),0.0,1.0);
}
#else
{
float l9_176;
...
{
l9_177=(1.0-dot(l9_169.xyz,vec3(0.33333001)))*l9_113;
}
#else
{
float l9_178;
...
{
l9_178=(1.0-clamp(dot(l9_169.xyz,vec3(1.0)),0.0,1.0))*l9_113;
}
#else
{
float l9_179;
...
{
l9_179=clamp(dot(l9_169.xyz,vec3(1.0)),0.0,1.0)*l9_113;
}
#else
{
float l9_180;
#if (sc_BlendMode_Add)
{
l9_180=clamp(dot(l9_169.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_181;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_181=clamp(dot(l9_169.xyz,vec3(1.0)),0.0,1.0)*l9_113;
}
#else
{
float l9_182;
...
{
l9_182=dot(l9_169.xyz,vec3(0.33333001))*l9_113;
}
#else
{
float l9_183;
#if (sc_BlendMode_Min)
{
l9_183=1.0-clamp(dot(l9_169.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_184;
#if (sc_BlendMode_Max)
{
l9_184=clamp(dot(l9_169.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_184=1.0;
...
#endif
l9_172=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_169.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_173);
}
#else
{
vec4 l9_185;
...
#if (sc_FramebufferFetch)
{
l9_187=sc_readFragData0_Platform();
}
#else
{
...
{
l9_189=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_188,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_189=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_188,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_187=l9_189;
}
#endif
vec3 l9_190=mix(l9_187.xyz,definedBlend(l9_187.xyz,l9_169.xyz).xyz,vec3(l9_113));
vec4 l9_191=vec4(l9_190.x,l9_190.y,l9_190.z,vec4(0.0).w);
l9_191.w=1.0;
l9_186=l9_191;
}
#else
...
#if (sc_Voxelization)
{
l9_192=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_193;
#if (sc_OutputBounds)
{
float l9_194=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_193=vec4(l9_194,1.0-l9_194,1.0,1.0);
}
#else
{
vec4 l9_195;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_195=vec4(mix(vec3(1.0),l9_169.xyz,vec3(l9_113)),l9_113);
}
#else
{
vec4 l9_196;
...
#endif
l9_196=vec4(l9_169.xyz*l9_197,l9_197);
}
#else
{
l9_196=l9_169;
...
vec4 l9_200=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_198,vec4(0.0)));
vec4 l9_201=clamp(l9_200,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_202=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_202-0.0039215689)),min(1.0,l9_202+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_203).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_204=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_203).xy);
float l9_205=packValue(l9_204);
int l9_212=int(l9_201.w*255.0);
float l9_213=packValue(l9_212);
sc_writeFragData0Internal(vec4(packValue(l9_204),packValue(l9_204),packValue(l9_204),packValue(l9_204)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_205,packValue(l9_204),packValue(l9_204),packValue(l9_204)));
sc_writeFragData2(vec4(l9_213,packValue(l9_212),packValue(l9_212),packValue(l9_212)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_216=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_216).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_221==0)
{
l9_224=texture(sc_OITAlpha0,l9_216);
l9_223=texture(sc_OITDepthLow0,l9_216);
l9_222=texture(sc_OITDepthHigh0,l9_216);
}
else
{
l9_224=vec4(0.0);
...
if (l9_221==1)
{
l9_227=texture(sc_OITAlpha1,l9_216);
l9_226=texture(sc_OITDepthLow1,l9_216);
l9_225=texture(sc_OITDepthHigh1,l9_216);
}
else
{
l9_227=l9_224;
...
if (any(notEqual(l9_225,vec4(0.0)))||any(notEqual(l9_226,vec4(0.0))))
{
int l9_228[8]=l9_217;
unpackValues(l9_225.w,l9_221,l9_228);
unpackValues(l9_225.z,l9_221,l9_228);
unpackValues(l9_225.y,l9_221,l9_228);
unpackValues(l9_225.x,l9_221,l9_228);
unpackValues(l9_226.w,l9_221,l9_228);
unpackValues(l9_226.z,l9_221,l9_228);
unpackValues(l9_226.y,l9_221,l9_228);
unpackValues(l9_226.x,l9_221,l9_228);
int l9_237[8]=l9_218;
unpackValues(l9_227.w,l9_221,l9_237);
unpackValues(l9_227.z,l9_221,l9_237);
unpackValues(l9_227.y,l9_221,l9_237);
unpackValues(l9_227.x,l9_221,l9_237);
}
l9_221++;
continue;
}
...
vec4 l9_242=texture(sc_OITFilteredDepthBoundsTexture,l9_216);
vec2 l9_243=l9_242.xy;
int l9_244;
#if (sc_SkinBonesCount>0)
{
l9_244=encodeDepth(((1.0-l9_242.x)*1000.0)+getDepthOrderingEpsilon(),l9_243);
}
#else
{
l9_244=0;
...
#endif
int l9_245=encodeDepth(viewSpaceDepth(),l9_243);
vec4 l9_246;
l9_246=l9_201*l9_201.w;
vec4 l9_247;
int l9_248=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_248<8)
{
int l9_249=l9_217[l9_248];
int l9_250=l9_245-l9_244;
bool l9_251=l9_249<l9_250;
bool l9_252;
if (l9_251)
{
l9_252=l9_217[l9_248]>0;
}
else
{
l9_252=l9_251;
...
if (l9_252)
{
vec3 l9_253=l9_246.xyz*(1.0-(float(l9_218[l9_248])/255.0));
l9_247=vec4(l9_253.x,l9_253.y,l9_253.z,l9_246.w);
}
else
{
l9_247=l9_246;
...
sc_writeFragData0Internal(l9_246,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_201,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_200,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
