...
uniform float sliceSizeLeft;
uniform float sliceSizeRight;
uniform float sliceSizeTop;
uniform float sliceSizeBottom;
...
vec2 l9_3=vec2(length(sc_ModelMatrix[0].xyz),length(sc_ModelMatrix[1].xyz));
bool l9_4=(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].w+0.00050000002)>0.0;
bool l9_5;
if (l9_4)
{
l9_5=(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].w-0.00050000002)<0.0;
}
else
{
l9_5=l9_4;
...
if (!l9_5)
{
l9_6=l9_3*(abs(vec2(0.0,sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][1].y)).y/0.1);
}
else
{
l9_6=l9_3;
}
float l9_7=min(min(borderScale,l9_6.x/2.0),l9_6.y/2.0);
float l9_8=(baseTexSize.x/baseTexSize.y)*l9_7;
float l9_9=((sliceSizeLeft*l9_8)*2.0)/l9_6.x;
float l9_10=1.0-(((sliceSizeRight*l9_8)*2.0)/l9_6.x);
float l9_11=((sliceSizeBottom*l9_7)*2.0)/l9_6.y;
float l9_12=1.0-(((sliceSizeTop*l9_7)*2.0)/l9_6.y);
float l9_13=1.0-sliceSizeRight;
float l9_14=1.0-sliceSizeTop;
float l9_15;
if (l9_1.x<l9_9)
{
l9_15=0.0+(((l9_1.x-0.0)*(sliceSizeLeft-0.0))/((l9_9-0.0)+1e-06));
}
else
{
l9_15=(l9_1.x<l9_10) ? (sliceSizeLeft+(((l9_1.x-l9_9)*(l9_13-sliceSizeLeft))/((l9_10-l9_9)+1e-06))) : (l9_13+(((l9_1.x-l9_10)*(1.0-l9_13))/((1.0-l9_10)+1e-06)));
}
float l9_16;
if (l9_1.y<l9_11)
{
l9_16=0.0+(((l9_1.y-0.0)*(sliceSizeBottom-0.0))/((l9_11-0.0)+1e-06));
}
else
{
l9_16=(l9_1.y<l9_12) ? (sliceSizeBottom+(((l9_1.y-l9_11)*(l9_14-sliceSizeBottom))/((l9_12-l9_11)+1e-06))) : (l9_14+(((l9_1.y-l9_12)*(1.0-l9_14))/((1.0-l9_12)+1e-06)));
}
vec4 l9_17;
#if (baseTexLayout==2)
{
...
#endif
vec4 l9_66=l9_17*shapeColor;
float l9_67=l9_66.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_67<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_67<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_68,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_70;
...
{
l9_73=clamp(dot(l9_66.xyz,vec3(l9_67)),0.0,1.0);
}
#else
{
float l9_74;
...
{
l9_75=(1.0-dot(l9_66.xyz,vec3(0.33333001)))*l9_67;
}
#else
{
float l9_76;
...
{
l9_76=(1.0-clamp(dot(l9_66.xyz,vec3(1.0)),0.0,1.0))*l9_67;
}
#else
{
float l9_77;
...
{
l9_77=clamp(dot(l9_66.xyz,vec3(1.0)),0.0,1.0)*l9_67;
}
#else
{
float l9_78;
#if (sc_BlendMode_Add)
{
l9_78=clamp(dot(l9_66.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_79;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_79=clamp(dot(l9_66.xyz,vec3(1.0)),0.0,1.0)*l9_67;
}
#else
{
float l9_80;
...
{
l9_80=dot(l9_66.xyz,vec3(0.33333001))*l9_67;
}
#else
{
float l9_81;
#if (sc_BlendMode_Min)
{
l9_81=1.0-clamp(dot(l9_66.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_82;
#if (sc_BlendMode_Max)
{
l9_82=clamp(dot(l9_66.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_82=1.0;
...
#endif
l9_70=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_66.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_71);
}
#else
{
vec4 l9_83;
...
#if (sc_FramebufferFetch)
{
l9_85=sc_readFragData0_Platform();
}
#else
{
vec2 l9_86=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_87;
#if (sc_ScreenTextureLayout==2)
{
l9_87=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_86,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_87=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_86,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_85=l9_87;
}
#endif
vec3 l9_88=mix(l9_85.xyz,definedBlend(l9_85.xyz,l9_66.xyz).xyz,vec3(l9_67));
vec4 l9_89=vec4(l9_88.x,l9_88.y,l9_88.z,vec4(0.0).w);
l9_89.w=1.0;
l9_84=l9_89;
}
#else
...
#if (sc_Voxelization)
{
l9_90=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_91;
#if (sc_OutputBounds)
{
float l9_92=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_91=vec4(l9_92,1.0-l9_92,1.0,1.0);
}
#else
{
vec4 l9_93;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_93=vec4(mix(vec3(1.0),l9_66.xyz,vec3(l9_67)),l9_67);
}
#else
{
vec4 l9_94;
...
#endif
l9_94=vec4(l9_66.xyz*l9_95,l9_95);
}
#else
{
l9_94=l9_66;
...
vec4 l9_98=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_96,vec4(0.0)));
vec4 l9_99=clamp(l9_98,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_100=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_100-0.0039215689)),min(1.0,l9_100+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_101=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_101).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_102=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_101).xy);
float l9_103=packValue(l9_102);
int l9_110=int(l9_99.w*255.0);
float l9_111=packValue(l9_110);
sc_writeFragData0Internal(vec4(packValue(l9_102),packValue(l9_102),packValue(l9_102),packValue(l9_102)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_103,packValue(l9_102),packValue(l9_102),packValue(l9_102)));
sc_writeFragData2(vec4(l9_111,packValue(l9_110),packValue(l9_110),packValue(l9_110)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_114=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_114).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_119==0)
{
l9_122=texture(sc_OITAlpha0,l9_114);
l9_121=texture(sc_OITDepthLow0,l9_114);
l9_120=texture(sc_OITDepthHigh0,l9_114);
}
else
{
l9_122=vec4(0.0);
...
if (l9_119==1)
{
l9_125=texture(sc_OITAlpha1,l9_114);
l9_124=texture(sc_OITDepthLow1,l9_114);
l9_123=texture(sc_OITDepthHigh1,l9_114);
}
else
{
l9_125=l9_122;
...
if (any(notEqual(l9_123,vec4(0.0)))||any(notEqual(l9_124,vec4(0.0))))
{
int l9_126[8]=l9_115;
unpackValues(l9_123.w,l9_119,l9_126);
unpackValues(l9_123.z,l9_119,l9_126);
unpackValues(l9_123.y,l9_119,l9_126);
unpackValues(l9_123.x,l9_119,l9_126);
unpackValues(l9_124.w,l9_119,l9_126);
unpackValues(l9_124.z,l9_119,l9_126);
unpackValues(l9_124.y,l9_119,l9_126);
unpackValues(l9_124.x,l9_119,l9_126);
int l9_135[8]=l9_116;
unpackValues(l9_125.w,l9_119,l9_135);
unpackValues(l9_125.z,l9_119,l9_135);
unpackValues(l9_125.y,l9_119,l9_135);
unpackValues(l9_125.x,l9_119,l9_135);
}
l9_119++;
continue;
}
...
vec4 l9_140=texture(sc_OITFilteredDepthBoundsTexture,l9_114);
vec2 l9_141=l9_140.xy;
int l9_142;
#if (sc_SkinBonesCount>0)
{
l9_142=encodeDepth(((1.0-l9_140.x)*1000.0)+getDepthOrderingEpsilon(),l9_141);
}
#else
{
l9_142=0;
...
#endif
int l9_143=encodeDepth(viewSpaceDepth(),l9_141);
vec4 l9_144;
l9_144=l9_99*l9_99.w;
vec4 l9_145;
int l9_146=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_146<8)
{
int l9_147=l9_115[l9_146];
int l9_148=l9_143-l9_142;
bool l9_149=l9_147<l9_148;
bool l9_150;
if (l9_149)
{
l9_150=l9_115[l9_146]>0;
}
else
{
l9_150=l9_149;
...
if (l9_150)
{
vec3 l9_151=l9_144.xyz*(1.0-(float(l9_116[l9_146])/255.0));
l9_145=vec4(l9_151.x,l9_151.y,l9_151.z,l9_144.w);
}
else
{
l9_145=l9_144;
...
sc_writeFragData0Internal(l9_144,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_99,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_98,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
