...
//spec_const bool NOMASK 31 0
//spec_const bool NOTEXTURE 32 0
...
//spec_const bool baseTexHasSwappedViews 43 0
//spec_const bool intensityTextureHasSwappedViews 44 0
//spec_const bool opacityTexHasSwappedViews 45 0
...
//spec_const bool sc_OITDepthPrepass 67 0
//spec_const bool sc_OITFrontLayerPass 68 0
//spec_const bool sc_OITMaxLayers4Plus1 69 0
//spec_const bool sc_OITMaxLayers8 70 0
//spec_const bool sc_OITMaxLayersVisualizeLayerCount 71 0
...
//spec_const bool sc_RayTracingCasterForceOpaque 75 0
//spec_const bool sc_RenderAlphaToColor 76 0
//spec_const bool sc_ScreenTextureHasSwappedViews 77 0
//spec_const bool sc_TAAEnabled 78 0
//spec_const bool sc_VertexBlending 79 0
//spec_const bool sc_VertexBlendingUseNormals 80 0
//spec_const bool sc_Voxelization 81 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 84 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 85 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 86 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 87 -1
...
uniform vec4 Port_Input1_N001;
uniform vec4 Port_Input1_N008;
uniform int PreviewEnabled;
...
{
l9_1=varPackedTex.xy;
}
vec4 l9_3;
#if (NOTEXTURE)
{
l9_3=Port_Input1_N001;
}
#else
{
vec4 l9_4;
...
vec4 l9_77=texture(opacityTexArrSC,l9_76,0.0);
vec4 l9_78;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
...
#else
{
bool l9_79=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_80=l9_1.x;
sc_SoftwareWrapEarly(l9_80,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_81=l9_80;
float l9_82=l9_1.y;
sc_SoftwareWrapEarly(l9_82,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_83=l9_82;
vec2 l9_84;
float l9_85;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_86=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
...
float l9_87=l9_81;
float l9_88=1.0;
sc_ClampUV(l9_87,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_86,l9_88);
float l9_89=l9_87;
float l9_90=l9_88;
bool l9_91;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_91=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_92=l9_83;
float l9_93=l9_90;
sc_ClampUV(l9_92,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_91,l9_93);
l9_85=l9_93;
...
#endif
vec2 l9_94=sc_TransformUV(l9_84,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_95=l9_94.x;
float l9_96=l9_85;
sc_SoftwareWrapLate(l9_95,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_79,l9_96);
float l9_97=l9_94.y;
float l9_98=l9_96;
sc_SoftwareWrapLate(l9_97,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_79,l9_98);
float l9_99=l9_98;
vec3 l9_100=sc_SamplingCoordsViewToGlobal(vec2(l9_95,l9_97),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_101=texture(opacityTex,l9_100.xy,0.0);
vec4 l9_102;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_102=mix(opacityTexBorderColor,l9_101,vec4(l9_99));
}
#else
{
l9_102=l9_101;
...
#endif
vec4 l9_103=vec4(l9_3.x,l9_3.y,l9_3.z,vec4(0.0).w);
l9_103.w=l9_53.x;
vec4 l9_104=baseColor*l9_103;
float l9_105=l9_104.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_105<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_105<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_106,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_108;
...
{
l9_110=clamp(l9_105*2.0,0.0,1.0);
}
#else
{
float l9_111;
...
{
l9_111=clamp(dot(l9_104.xyz,vec3(l9_105)),0.0,1.0);
}
#else
{
float l9_112;
...
{
l9_113=(1.0-dot(l9_104.xyz,vec3(0.33333001)))*l9_105;
}
#else
{
float l9_114;
...
{
l9_114=(1.0-clamp(dot(l9_104.xyz,vec3(1.0)),0.0,1.0))*l9_105;
}
#else
{
float l9_115;
...
{
l9_115=clamp(dot(l9_104.xyz,vec3(1.0)),0.0,1.0)*l9_105;
}
#else
{
float l9_116;
#if (sc_BlendMode_Add)
{
l9_116=clamp(dot(l9_104.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_117;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_117=clamp(dot(l9_104.xyz,vec3(1.0)),0.0,1.0)*l9_105;
}
#else
{
float l9_118;
...
{
l9_118=dot(l9_104.xyz,vec3(0.33333001))*l9_105;
}
#else
{
float l9_119;
#if (sc_BlendMode_Min)
{
l9_119=1.0-clamp(dot(l9_104.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_120;
#if (sc_BlendMode_Max)
{
l9_120=clamp(dot(l9_104.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_120=1.0;
...
#endif
l9_108=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_104.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_109);
}
#else
{
vec4 l9_121;
...
#if (sc_FramebufferFetch)
{
l9_123=sc_readFragData0_Platform();
}
#else
{
vec2 l9_124=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_125;
#if (sc_ScreenTextureLayout==2)
{
l9_125=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_124,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_125=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_124,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_123=l9_125;
}
#endif
vec3 l9_126=mix(l9_123.xyz,definedBlend(l9_123.xyz,l9_104.xyz).xyz,vec3(l9_105));
vec4 l9_127=vec4(l9_126.x,l9_126.y,l9_126.z,vec4(0.0).w);
l9_127.w=1.0;
l9_122=l9_127;
}
#else
...
#if (sc_Voxelization)
{
l9_128=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_129;
#if (sc_OutputBounds)
{
float l9_130=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_129=vec4(l9_130,1.0-l9_130,1.0,1.0);
}
#else
{
vec4 l9_131;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_131=vec4(mix(vec3(1.0),l9_104.xyz,vec3(l9_105)),l9_105);
}
#else
{
vec4 l9_132;
...
#endif
l9_132=vec4(l9_104.xyz*l9_133,l9_133);
}
#else
{
l9_132=l9_104;
...
vec4 l9_136=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_134,vec4(0.0)));
vec4 l9_137=clamp(l9_136,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_138=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_138-0.0039215689)),min(1.0,l9_138+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_139=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_139).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_140=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_139).xy);
float l9_141=packValue(l9_140);
int l9_148=int(l9_137.w*255.0);
float l9_149=packValue(l9_148);
sc_writeFragData0Internal(vec4(packValue(l9_140),packValue(l9_140),packValue(l9_140),packValue(l9_140)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_141,packValue(l9_140),packValue(l9_140),packValue(l9_140)));
sc_writeFragData2(vec4(l9_149,packValue(l9_148),packValue(l9_148),packValue(l9_148)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_152).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_157==0)
{
l9_160=texture(sc_OITAlpha0,l9_152);
l9_159=texture(sc_OITDepthLow0,l9_152);
l9_158=texture(sc_OITDepthHigh0,l9_152);
}
else
{
l9_160=vec4(0.0);
...
if (l9_157==1)
{
l9_163=texture(sc_OITAlpha1,l9_152);
l9_162=texture(sc_OITDepthLow1,l9_152);
l9_161=texture(sc_OITDepthHigh1,l9_152);
}
else
{
l9_163=l9_160;
...
if (any(notEqual(l9_161,vec4(0.0)))||any(notEqual(l9_162,vec4(0.0))))
{
int l9_164[8]=l9_153;
unpackValues(l9_161.w,l9_157,l9_164);
unpackValues(l9_161.z,l9_157,l9_164);
unpackValues(l9_161.y,l9_157,l9_164);
unpackValues(l9_161.x,l9_157,l9_164);
unpackValues(l9_162.w,l9_157,l9_164);
unpackValues(l9_162.z,l9_157,l9_164);
unpackValues(l9_162.y,l9_157,l9_164);
unpackValues(l9_162.x,l9_157,l9_164);
int l9_173[8]=l9_154;
unpackValues(l9_163.w,l9_157,l9_173);
unpackValues(l9_163.z,l9_157,l9_173);
unpackValues(l9_163.y,l9_157,l9_173);
unpackValues(l9_163.x,l9_157,l9_173);
}
l9_157++;
continue;
}
...
vec4 l9_178=texture(sc_OITFilteredDepthBoundsTexture,l9_152);
vec2 l9_179=l9_178.xy;
int l9_180;
#if (sc_SkinBonesCount>0)
{
l9_180=encodeDepth(((1.0-l9_178.x)*1000.0)+getDepthOrderingEpsilon(),l9_179);
}
#else
{
l9_180=0;
...
#endif
int l9_181=encodeDepth(viewSpaceDepth(),l9_179);
vec4 l9_182;
l9_182=l9_137*l9_137.w;
vec4 l9_183;
int l9_184=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_184<8)
{
int l9_185=l9_153[l9_184];
int l9_186=l9_181-l9_180;
bool l9_187=l9_185<l9_186;
bool l9_188;
if (l9_187)
{
l9_188=l9_153[l9_184]>0;
}
else
{
l9_188=l9_187;
...
if (l9_188)
{
vec3 l9_189=l9_182.xyz*(1.0-(float(l9_154[l9_184])/255.0));
l9_183=vec4(l9_189.x,l9_189.y,l9_189.z,l9_182.w);
}
else
{
l9_183=l9_182;
...
sc_writeFragData0Internal(l9_182,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_137,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_136,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
