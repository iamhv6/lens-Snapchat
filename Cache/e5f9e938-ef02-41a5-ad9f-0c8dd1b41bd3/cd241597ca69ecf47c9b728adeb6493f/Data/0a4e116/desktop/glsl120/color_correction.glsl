...
float l9_61=l9_59.x;
sc_SoftwareWrapEarly(l9_61,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_62=l9_61;
float l9_63=l9_59.z;
float l9_64=l9_63;
sc_SoftwareWrapEarly(l9_64,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_65=l9_64;
vec2 l9_66;
float l9_67;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_68=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
...
float l9_69=l9_62;
float l9_70=1.0;
sc_ClampUV(l9_69,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_68,l9_70);
float l9_71=l9_69;
float l9_72=l9_70;
bool l9_73;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_73=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
...
float l9_74=l9_65;
float l9_75=l9_72;
sc_ClampUV(l9_74,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_73,l9_75);
l9_67=l9_75;
...
{
l9_67=1.0;
l9_66=vec2(l9_62,l9_65);
}
#endif
vec2 l9_76=sc_TransformUV(l9_66,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_77=l9_76.x;
float l9_78=l9_67;
sc_SoftwareWrapLate(l9_77,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_60,l9_78);
float l9_79=l9_76.y;
float l9_80=l9_78;
sc_SoftwareWrapLate(l9_79,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_60,l9_80);
float l9_81=l9_80;
vec3 l9_82=sc_SamplingCoordsViewToGlobal(vec2(l9_77,l9_79),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_83=texture2D(baseTex,l9_82.xy,0.0);
vec4 l9_84;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_84=mix(baseTexBorderColor,l9_83,vec4(l9_81));
}
#else
{
l9_84=l9_83;
...
#endif
float l9_85=l9_59.y;
sc_SoftwareWrapEarly(l9_85,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_86=l9_85;
float l9_87=l9_63;
sc_SoftwareWrapEarly(l9_87,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_88=l9_87;
vec2 l9_89;
float l9_90;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_91=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
...
float l9_92=l9_86;
float l9_93=1.0;
sc_ClampUV(l9_92,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_91,l9_93);
float l9_94=l9_92;
float l9_95=l9_93;
bool l9_96;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_96=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
...
float l9_97=l9_88;
float l9_98=l9_95;
sc_ClampUV(l9_97,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_96,l9_98);
l9_90=l9_98;
...
#endif
vec2 l9_99=sc_TransformUV(l9_89,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_100=l9_99.x;
float l9_101=l9_90;
sc_SoftwareWrapLate(l9_100,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_60,l9_101);
float l9_102=l9_99.y;
float l9_103=l9_101;
sc_SoftwareWrapLate(l9_102,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_60,l9_103);
float l9_104=l9_103;
vec3 l9_105=sc_SamplingCoordsViewToGlobal(vec2(l9_100,l9_102),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_106=texture2D(baseTex,l9_105.xy,0.0);
vec4 l9_107;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_107=mix(baseTexBorderColor,l9_106,vec4(l9_104));
}
#else
{
l9_107=l9_106;
...
#endif
float l9_108;
Node11_Conditional(1.0,1.0,Port_Input2_N011,l9_108,l9_2);
l9_3=vec4(mix(l9_56.xyz,vec4(mix(l9_84.xyz,l9_107.xyz,vec3(l9_57-l9_58.x)),0.0).xyz*baseColor.xyz,vec3(baseColor.w*l9_108)),1.0);
}
#endif
...
{
l9_111=clamp(l9_3.w*2.0,0.0,1.0);
}
#else
{
float l9_112;
...
{
l9_112=clamp(dot(l9_3.xyz,vec3(l9_3.w)),0.0,1.0);
}
#else
{
float l9_113;
...
{
l9_114=(1.0-dot(l9_3.xyz,vec3(0.33333001)))*l9_3.w;
}
#else
{
float l9_115;
...
{
l9_115=(1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0))*l9_3.w;
}
#else
{
float l9_116;
...
{
l9_116=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_3.w;
}
#else
{
float l9_117;
#if (sc_BlendMode_Add)
{
l9_117=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_118;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_118=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_3.w;
}
#else
{
float l9_119;
...
{
l9_119=dot(l9_3.xyz,vec3(0.33333001))*l9_3.w;
}
#else
{
float l9_120;
#if (sc_BlendMode_Min)
{
l9_120=1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_121;
#if (sc_BlendMode_Max)
{
l9_121=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_121=1.0;
...
#endif
l9_109=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_3.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_110);
}
#else
{
vec4 l9_122;
...
#if (sc_FramebufferFetch)
{
l9_124=sc_readFragData0_Platform();
}
#else
{
vec2 l9_125=sc_ScreenCoordsGlobalToView(l9_0);
int l9_126;
...
#endif
l9_124=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_125,sc_ScreenTextureLayout,l9_126).xy,0.0);
}
#endif
vec3 l9_127=mix(l9_124.xyz,definedBlend(l9_124.xyz,l9_3.xyz).xyz,vec3(l9_3.w));
vec4 l9_128=vec4(l9_127.x,l9_127.y,l9_127.z,vec4(0.0).w);
l9_128.w=1.0;
l9_123=l9_128;
}
#else
...
#if (sc_Voxelization)
{
l9_129=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_130;
#if (sc_OutputBounds)
{
float l9_131=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_130=vec4(l9_131,1.0-l9_131,1.0,1.0);
}
#else
{
vec4 l9_132;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_132=vec4(mix(vec3(1.0),l9_3.xyz,vec3(l9_3.w)),l9_3.w);
}
#else
{
vec4 l9_133;
...
#endif
l9_133=vec4(l9_3.xyz*l9_134,l9_134);
}
#else
{
l9_133=l9_3;
...
vec4 l9_137=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_135,vec4(0.0)));
vec4 l9_138=clamp(l9_137,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_139=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_139-0.0039215689)),min(1.0,l9_139+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_140=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_140).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_141=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_140).xy);
float l9_142=packValue(l9_141);
int l9_149=int(l9_138.w*255.0);
float l9_150=packValue(l9_149);
sc_writeFragData0Internal(vec4(packValue(l9_141),packValue(l9_141),packValue(l9_141),packValue(l9_141)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_142,packValue(l9_141),packValue(l9_141),packValue(l9_141)));
sc_writeFragData2(vec4(l9_150,packValue(l9_149),packValue(l9_149),packValue(l9_149)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_153=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_153).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_158==0)
{
l9_161=texture2D(sc_OITAlpha0,l9_153);
l9_160=texture2D(sc_OITDepthLow0,l9_153);
l9_159=texture2D(sc_OITDepthHigh0,l9_153);
}
else
{
l9_161=vec4(0.0);
...
if (l9_158==1)
{
l9_164=texture2D(sc_OITAlpha1,l9_153);
l9_163=texture2D(sc_OITDepthLow1,l9_153);
l9_162=texture2D(sc_OITDepthHigh1,l9_153);
}
else
{
l9_164=l9_161;
...
if (any(notEqual(l9_162,vec4(0.0)))||any(notEqual(l9_163,vec4(0.0))))
{
int l9_165[8]=l9_154;
unpackValues(l9_162.w,l9_158,l9_165);
unpackValues(l9_162.z,l9_158,l9_165);
unpackValues(l9_162.y,l9_158,l9_165);
unpackValues(l9_162.x,l9_158,l9_165);
unpackValues(l9_163.w,l9_158,l9_165);
unpackValues(l9_163.z,l9_158,l9_165);
unpackValues(l9_163.y,l9_158,l9_165);
unpackValues(l9_163.x,l9_158,l9_165);
int l9_174[8]=l9_155;
unpackValues(l9_164.w,l9_158,l9_174);
unpackValues(l9_164.z,l9_158,l9_174);
unpackValues(l9_164.y,l9_158,l9_174);
unpackValues(l9_164.x,l9_158,l9_174);
}
l9_158++;
continue;
}
...
vec4 l9_179=texture2D(sc_OITFilteredDepthBoundsTexture,l9_153);
vec2 l9_180=l9_179.xy;
int l9_181;
#if (sc_SkinBonesCount>0)
{
l9_181=encodeDepth(((1.0-l9_179.x)*1000.0)+getDepthOrderingEpsilon(),l9_180);
}
#else
{
l9_181=0;
...
#endif
int l9_182=encodeDepth(viewSpaceDepth(),l9_180);
vec4 l9_183;
l9_183=l9_138*l9_138.w;
vec4 l9_184;
int l9_185=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_185<8)
{
int l9_186=l9_154[l9_185];
int l9_187=l9_182-l9_181;
bool l9_188=l9_186<l9_187;
bool l9_189;
if (l9_188)
{
l9_189=l9_154[l9_185]>0;
}
else
{
l9_189=l9_188;
...
if (l9_189)
{
vec3 l9_190=l9_183.xyz*(1.0-(float(l9_155[l9_185])/255.0));
l9_184=vec4(l9_190.x,l9_190.y,l9_190.z,l9_183.w);
}
else
{
l9_184=l9_183;
...
sc_writeFragData0Internal(l9_183,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
