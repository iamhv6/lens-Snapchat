...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 80 -1
//spec_const int baseTexLayout 81 0
...
//spec_const int sc_StereoViewID 90 0
//SG_REFLECTION_END
#ifdef alpha_channel
#undef alpha_channel
#endif
...
uniform bool envmap_preview;
uniform vec2 Port_Input1_N057;
...
void Node59_If_else(float Bool1,vec4 Value1,vec4 Default,out vec4 Result,ssGlobals Globals)
{
Bool1=float(envmap_preview);
if ((Bool1*1.0)!=0.0)
{
vec2 l9_0=Globals.Surface_UVCoord0;
vec2 l9_1=l9_0*Port_Input1_N057;
vec4 l9_2;
#if (baseTexLayout==2)
{
...
#endif
N16_Value1=l9_2;
vec3 l9_51=N16_Value1.xyz/vec3(N16_Value1.w);
N16_Result=vec4(l9_51.x,l9_51.y,l9_51.z,N16_Result.w);
N16_Result.w=1.0;
Value1=ssLinear_to_SRGB(vec4(linearToneMapping(N16_Result.xyz),N16_Result.w));
Result=Value1;
}
else
{
vec2 l9_52=Globals.Surface_UVCoord0;
vec2 l9_53=l9_52*Port_Input1_N057;
vec4 l9_54;
#if (baseTexLayout==2)
{
...
{
vec4 param_3;
Node59_If_else(0.0,vec4(0.0),vec4(0.0),param_3,Globals);
Default=param_3.w;
Result=Default;
}
}
...
{
vec4 l9_12;
Node59_If_else(0.0,vec4(0.0),vec4(0.0),l9_12,l9_3);
vec3 l9_13=vec3(l9_12.w);
vec4 l9_14=vec4(l9_13.x,l9_13.y,l9_13.z,vec4(0.0).w);
l9_14.w=Port_Value2_N013;
l9_11=l9_14;
}
else
{
...
{
vec4 l9_16;
Node59_If_else(0.0,vec4(0.0),vec4(0.0),l9_16,l9_3);
float l9_17;
if ((float(l9_4==Port_Input1_N035)*1.0)!=0.0)
{
l9_17=Port_Value1_N036;
}
else
{
vec4 l9_18;
Node59_If_else(0.0,vec4(0.0),vec4(0.0),l9_18,l9_3);
l9_17=l9_18.w;
}
l9_15=vec4(l9_5*l9_16.x,l9_6*l9_16.y,l9_16.z*l9_7,l9_17);
}
else
{
vec4 l9_19;
...
{
vec4 l9_21;
Node59_If_else(0.0,vec4(0.0),vec4(0.0),l9_21,l9_3);
float l9_22;
Node43_If_else(0.0,Port_Value1_N043,0.0,l9_22,l9_3);
l9_20=vec4(l9_21.xxx,l9_22);
}
else
{
vec4 l9_23;
...
{
vec4 l9_24;
Node59_If_else(0.0,vec4(0.0),vec4(0.0),l9_24,l9_3);
float l9_25;
Node43_If_else(0.0,Port_Value1_N043,0.0,l9_25,l9_3);
l9_23=vec4(l9_24.yyy,l9_25);
}
else
{
vec4 l9_26;
...
{
vec4 l9_27;
Node59_If_else(0.0,vec4(0.0),vec4(0.0),l9_27,l9_3);
float l9_28;
Node43_If_else(0.0,Port_Value1_N043,0.0,l9_28,l9_3);
l9_26=vec4(l9_27.zzz,l9_28);
}
else
{
l9_26=Port_Default_N055;
}
l9_23=l9_26;
}
l9_20=l9_23;
...
#endif
sc_writeFragData0Internal(max(l9_29,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_31;
...
{
l9_33=clamp(l9_11.w*2.0,0.0,1.0);
}
#else
{
float l9_34;
...
{
l9_34=clamp(dot(l9_11.xyz,vec3(l9_11.w)),0.0,1.0);
}
#else
{
float l9_35;
...
{
l9_36=(1.0-dot(l9_11.xyz,vec3(0.33333001)))*l9_11.w;
}
#else
{
float l9_37;
...
{
l9_37=(1.0-clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0))*l9_11.w;
}
#else
{
float l9_38;
...
{
l9_38=clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0)*l9_11.w;
}
#else
{
float l9_39;
#if (sc_BlendMode_Add)
{
l9_39=clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_40;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_40=clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0)*l9_11.w;
}
#else
{
float l9_41;
...
{
l9_41=dot(l9_11.xyz,vec3(0.33333001))*l9_11.w;
}
#else
{
float l9_42;
#if (sc_BlendMode_Min)
{
l9_42=1.0-clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_43;
#if (sc_BlendMode_Max)
{
l9_43=clamp(dot(l9_11.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_43=1.0;
...
#endif
l9_31=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_11.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_32);
}
#else
{
vec4 l9_44;
...
#if (sc_FramebufferFetch)
{
l9_46=sc_readFragData0_Platform();
}
#else
{
...
{
l9_48=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_47,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_48=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_47,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_46=l9_48;
}
#endif
vec3 l9_49=mix(l9_46.xyz,definedBlend(l9_46.xyz,l9_11.xyz).xyz,vec3(l9_11.w));
vec4 l9_50=vec4(l9_49.x,l9_49.y,l9_49.z,vec4(0.0).w);
l9_50.w=1.0;
l9_45=l9_50;
}
#else
...
#if (sc_Voxelization)
{
l9_51=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_52;
#if (sc_OutputBounds)
{
float l9_53=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_52=vec4(l9_53,1.0-l9_53,1.0,1.0);
}
#else
{
vec4 l9_54;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_54=vec4(mix(vec3(1.0),l9_11.xyz,vec3(l9_11.w)),l9_11.w);
}
#else
{
vec4 l9_55;
...
#endif
l9_55=vec4(l9_11.xyz*l9_56,l9_56);
}
#else
{
l9_55=l9_11;
...
vec4 l9_59=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_57,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_61-0.0039215689)),min(1.0,l9_61+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_62=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
...
sc_writeFragData0Internal(vec4(packValue(l9_63),packValue(l9_63),packValue(l9_63),packValue(l9_63)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
#if (sc_OITCompositingPass)
{
vec2 l9_75=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
...
sc_writeFragData0Internal(l9_60,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_59,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
