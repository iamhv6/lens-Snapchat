...
#endif
sc_writeFragData0Internal(max(l9_509,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_511;
#if (sc_ProjectiveShadowsCaster)
...
vec4 l9_539=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_537,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_541-0.0039215689)),min(1.0,l9_541+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_543),packValue(l9_543),packValue(l9_543),packValue(l9_543)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_544,packValue(l9_543),packValue(l9_543),packValue(l9_543)));
sc_writeFragData2(vec4(l9_552,packValue(l9_551),packValue(l9_551),packValue(l9_551)));
...
sc_writeFragData0Internal(l9_585,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_540,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_539,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
