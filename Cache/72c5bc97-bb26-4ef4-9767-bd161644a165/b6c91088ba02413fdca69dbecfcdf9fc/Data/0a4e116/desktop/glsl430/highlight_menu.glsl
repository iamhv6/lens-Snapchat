...
#endif
uvec3 l9_479=uvec3(round((varPos-sc_RayTracingOriginOffset)*sc_RayTracingOriginScale));
...
#if (ENABLE_MATERIAL_PARAM_TEX)
{
vec2 l9_452=N7_getUV(NODE_221_DROPLIST_ITEM);
#if (materialParamsTexLayout==2)
{
bool l9_453=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_454=l9_452.x;
sc_SoftwareWrapEarly(l9_454,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_455=l9_454;
float l9_456=l9_452.y;
sc_SoftwareWrapEarly(l9_456,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_457=l9_456;
vec2 l9_458;
float l9_459;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_460=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_460=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_461=l9_455;
float l9_462=1.0;
sc_ClampUV(l9_461,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_460,l9_462);
float l9_463=l9_461;
float l9_464=l9_462;
bool l9_465;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_465=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
...
float l9_466=l9_457;
float l9_467=l9_464;
sc_ClampUV(l9_466,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_465,l9_467);
l9_459=l9_467;
l9_458=vec2(l9_463,l9_466);
}
#else
{
l9_459=1.0;
l9_458=vec2(l9_455,l9_457);
}
#endif
vec2 l9_468=sc_TransformUV(l9_458,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_469=l9_468.x;
float l9_470=l9_459;
sc_SoftwareWrapLate(l9_469,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_453,l9_470);
float l9_471=l9_468.y;
float l9_472=l9_470;
sc_SoftwareWrapLate(l9_471,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_453,l9_472);
}
#else
{
bool l9_473=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_474=l9_452.x;
sc_SoftwareWrapEarly(l9_474,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_475=l9_474;
float l9_476=l9_452.y;
sc_SoftwareWrapEarly(l9_476,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_477=l9_476;
vec2 l9_478;
float l9_479;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_480=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_480=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_481=l9_475;
float l9_482=1.0;
sc_ClampUV(l9_481,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_480,l9_482);
float l9_483=l9_481;
float l9_484=l9_482;
bool l9_485;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_485=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_485=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_486=l9_477;
float l9_487=l9_484;
sc_ClampUV(l9_486,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_485,l9_487);
l9_479=l9_487;
l9_478=vec2(l9_483,l9_486);
}
#else
{
l9_479=1.0;
l9_478=vec2(l9_475,l9_477);
}
#endif
vec2 l9_488=sc_TransformUV(l9_478,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_489=l9_488.x;
float l9_490=l9_479;
sc_SoftwareWrapLate(l9_489,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_473,l9_490);
float l9_491=l9_488.y;
float l9_492=l9_490;
sc_SoftwareWrapLate(l9_491,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_473,l9_492);
}
#endif
}
#endif
...
#endif
float l9_494=clamp(l9_124,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_494<alphaTestThreshold)
{
discard;
}
}
...
#if (ENABLE_STIPPLE_PATTERN_TEST)
{
if (l9_494<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_495=max(l9_123.xyz,vec3(0.0));
vec4 l9_496;
#if (sc_ProjectiveShadowsCaster)
{
l9_496=vec4(l9_495,l9_494);
}
#else
{
l9_496=ngsCalculateLighting(l9_495,l9_494,l9_493,l9_8,l9_9,max(l9_451,vec3(0.0)),0.0,1.0,Port_AO_N036,vec3(1.0));
}
#endif
vec4 l9_497=max(l9_496,vec4(0.0));
if (l9_0)
{
vec4 l9_498;
...
#endif
sc_writeFragData0Internal(max(l9_498,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_500;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_502=clamp(l9_497.w*2.0,0.0,1.0);
}
#else
{
float l9_503;
...
{
l9_503=clamp(dot(l9_497.xyz,vec3(l9_497.w)),0.0,1.0);
}
#else
{
float l9_504;
...
#if (sc_BlendMode_Multiply)
{
l9_505=(1.0-dot(l9_497.xyz,vec3(0.33333001)))*l9_497.w;
}
#else
{
float l9_506;
...
{
l9_506=(1.0-clamp(dot(l9_497.xyz,vec3(1.0)),0.0,1.0))*l9_497.w;
}
#else
{
float l9_507;
#if (sc_BlendMode_ColoredGlass)
{
l9_507=clamp(dot(l9_497.xyz,vec3(1.0)),0.0,1.0)*l9_497.w;
}
#else
{
float l9_508;
#if (sc_BlendMode_Add)
{
l9_508=clamp(dot(l9_497.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_509;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_509=clamp(dot(l9_497.xyz,vec3(1.0)),0.0,1.0)*l9_497.w;
}
#else
{
float l9_510;
...
{
l9_510=dot(l9_497.xyz,vec3(0.33333001))*l9_497.w;
}
#else
{
float l9_511;
#if (sc_BlendMode_Min)
{
l9_511=1.0-clamp(dot(l9_497.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_512;
#if (sc_BlendMode_Max)
{
l9_512=clamp(dot(l9_497.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_512=1.0;
...
#endif
l9_500=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_497.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_501);
}
#else
{
vec4 l9_513;
...
{
vec3 l9_515=sc_GetFramebufferColor().xyz;
vec3 l9_516=mix(l9_515,definedBlend(l9_515,l9_497.xyz).xyz,vec3(l9_497.w));
vec4 l9_517=vec4(l9_516.x,l9_516.y,l9_516.z,vec4(0.0).w);
l9_517.w=1.0;
l9_514=l9_517;
}
#else
...
#if (sc_Voxelization)
{
l9_518=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_519;
#if (sc_OutputBounds)
{
float l9_520=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_519=vec4(l9_520,1.0-l9_520,1.0,1.0);
}
#else
{
vec4 l9_521;
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_522=l9_497.w;
l9_521=vec4(mix(vec3(1.0),l9_497.xyz,vec3(l9_522)),l9_522);
}
#else
{
vec4 l9_523;
...
{
float l9_524=l9_497.w;
float l9_525;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_525=clamp(l9_524,0.0,1.0);
}
#else
{
l9_525=l9_524;
...
#endif
l9_523=vec4(l9_497.xyz*l9_525,l9_525);
}
#else
{
l9_523=l9_497;
...
vec4 l9_528=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_526,vec4(0.0)));
vec4 l9_529=clamp(l9_528,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_530=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_530-0.0039215689)),min(1.0,l9_530+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_531=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_531).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_532=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_531).xy);
float l9_533=packValue(l9_532);
int l9_540=int(l9_529.w*255.0);
float l9_541=packValue(l9_540);
sc_writeFragData0Internal(vec4(packValue(l9_532),packValue(l9_532),packValue(l9_532),packValue(l9_532)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_533,packValue(l9_532),packValue(l9_532),packValue(l9_532)));
sc_writeFragData2(vec4(l9_541,packValue(l9_540),packValue(l9_540),packValue(l9_540)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_544=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_544).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_549==0)
{
l9_552=texture(sc_OITAlpha0,l9_544);
l9_551=texture(sc_OITDepthLow0,l9_544);
l9_550=texture(sc_OITDepthHigh0,l9_544);
}
else
{
l9_552=vec4(0.0);
...
if (l9_549==1)
{
l9_555=texture(sc_OITAlpha1,l9_544);
l9_554=texture(sc_OITDepthLow1,l9_544);
l9_553=texture(sc_OITDepthHigh1,l9_544);
}
else
{
l9_555=l9_552;
...
if (any(notEqual(l9_553,vec4(0.0)))||any(notEqual(l9_554,vec4(0.0))))
{
int l9_556[8]=l9_545;
unpackValues(l9_553.w,l9_549,l9_556);
unpackValues(l9_553.z,l9_549,l9_556);
unpackValues(l9_553.y,l9_549,l9_556);
unpackValues(l9_553.x,l9_549,l9_556);
unpackValues(l9_554.w,l9_549,l9_556);
unpackValues(l9_554.z,l9_549,l9_556);
unpackValues(l9_554.y,l9_549,l9_556);
unpackValues(l9_554.x,l9_549,l9_556);
int l9_565[8]=l9_546;
unpackValues(l9_555.w,l9_549,l9_565);
unpackValues(l9_555.z,l9_549,l9_565);
unpackValues(l9_555.y,l9_549,l9_565);
unpackValues(l9_555.x,l9_549,l9_565);
}
l9_549++;
continue;
}
...
vec4 l9_570=texture(sc_OITFilteredDepthBoundsTexture,l9_544);
vec2 l9_571=l9_570.xy;
int l9_572;
#if (sc_SkinBonesCount>0)
{
l9_572=encodeDepth(((1.0-l9_570.x)*1000.0)+getDepthOrderingEpsilon(),l9_571);
}
#else
{
l9_572=0;
...
#endif
int l9_573=encodeDepth(viewSpaceDepth(),l9_571);
vec4 l9_574;
l9_574=l9_529*l9_529.w;
vec4 l9_575;
int l9_576=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_576<8)
{
int l9_577=l9_545[l9_576];
int l9_578=l9_573-l9_572;
bool l9_579=l9_577<l9_578;
bool l9_580;
if (l9_579)
{
l9_580=l9_545[l9_576]>0;
}
else
{
l9_580=l9_579;
...
if (l9_580)
{
vec3 l9_581=l9_574.xyz*(1.0-(float(l9_546[l9_576])/255.0));
l9_575=vec4(l9_581.x,l9_581.y,l9_581.z,l9_574.w);
}
else
{
l9_575=l9_574;
...
sc_writeFragData0Internal(l9_574,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_529,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_528,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
