...
#endif
sc_writeFragData0Internal(max(l9_317,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_319;
...
#if (sc_FramebufferFetch)
{
l9_334=sc_readFragData0_Platform();
}
#else
{
...
vec4 l9_347=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_345,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_349-0.0039215689)),min(1.0,l9_349+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_351),packValue(l9_351),packValue(l9_351),packValue(l9_351)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_352,packValue(l9_351),packValue(l9_351),packValue(l9_351)));
sc_writeFragData2(vec4(l9_360,packValue(l9_359),packValue(l9_359),packValue(l9_359)));
...
sc_writeFragData0Internal(l9_393,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_348,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_347,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
