...
//texture texture2D intensityTexture 2:0:2:17
//texture texture2D sc_OITAlpha0 2:3:2:20
//texture texture2D sc_OITAlpha1 2:4:2:20
//texture texture2D sc_OITDepthHigh0 2:5:2:20
//texture texture2D sc_OITDepthHigh1 2:6:2:20
//texture texture2D sc_OITDepthLow0 2:7:2:20
//texture texture2D sc_OITDepthLow1 2:8:2:20
//texture texture2D sc_OITFilteredDepthBoundsTexture 2:9:2:20
//texture texture2D sc_OITFrontDepthTexture 2:10:2:20
//texture texture2D sc_ScreenTexture 2:12:2:22
//SG_REFLECTION_END
...
uniform vec4 strokeTextureDims;
...
uniform vec4 strokeTextureSize;
uniform vec4 strokeTextureView;
...
uniform float Port_Import_N313;
...
uniform float Port_Import_N317;
...
uniform vec4 Port_Import_N158;
uniform vec4 Port_Import_N159;
...
uniform vec2 Port_Import_N176;
uniform vec2 Port_Center_N177;
uniform vec2 Port_Import_N178;
uniform vec2 Port_Import_N180;
uniform float Port_Input1_N185;
uniform float Port_Input2_N185;
uniform vec4 Port_Import_N195;
uniform vec4 Port_Import_N196;
...
uniform vec2 Port_Import_N199;
uniform vec2 Port_Import_N200;
uniform vec4 Port_Import_N204;
uniform vec4 Port_Import_N205;
...
uniform vec4 Port_Import_N222;
uniform vec4 Port_Import_N223;
uniform float Port_Input0_N236;
uniform float Port_Input1_N236;
uniform float Port_RangeMinA_N225;
uniform float Port_RangeMaxA_N225;
uniform float Port_RangeMinB_N225;
uniform float Port_RangeMaxB_N225;
uniform vec2 Port_Import_N226;
uniform vec2 Port_Center_N227;
uniform vec2 Port_Import_N228;
uniform vec2 Port_Import_N230;
uniform float Port_Input1_N235;
uniform float Port_Input2_N235;
uniform vec4 Port_Import_N243;
uniform vec4 Port_Import_N244;
uniform float Port_RangeMinA_N246;
uniform float Port_RangeMaxA_N246;
uniform float Port_RangeMinB_N246;
uniform float Port_RangeMaxB_N246;
uniform vec2 Port_Import_N247;
uniform vec2 Port_Import_N248;
uniform vec4 Port_Import_N252;
uniform vec4 Port_Import_N253;
uniform vec4 Port_Default_N257;
uniform vec4 Port_Default_N173;
...
{
l9_63=vec2((intensityTextureTransform*vec3(l9_53,1.0)).xy);
}
#else
{
l9_63=l9_53;
...
float l9_68=l9_67;
vec4 l9_69=sc_SampleView(intensityTextureDims.xy,vec2(l9_64,l9_66),intensityTextureLayout,l9_48,0.0,intensityTexture);
vec4 l9_70;
#if (SC_USE_CLAMP_TO_BORDER_intensityTexture)
{
l9_70=mix(intensityTextureBorderColor,l9_69,vec4(l9_68));
}
#else
{
l9_70=l9_69;
...
#endif
float l9_71=((((l9_70.x*256.0)+l9_70.y)+(l9_70.z/256.0))/257.00391)*16.0;
float l9_72;
...
#endif
return transformColor(l9_47,l9_45,l9_46,1.0,l9_73);
}
#endif
}
#endif
...
#endif
vec4 l9_0=vec4(((((0.001-0.001)-Port_RangeMinA_N136)/(Port_RangeMaxA_N136-Port_RangeMinA_N136))*(Port_RangeMaxB_N136-Port_RangeMinB_N136))+Port_RangeMinB_N136);
float l9_1=floor(float(xRightPin));
float l9_2;
if (l9_1==0.0)
{
l9_2=Port_Value0_N287;
}
else
{
float l9_3;
...
#if ((Tweak_N139)==0)
{
l9_4=(Port_Value_N288+0.001)-0.001;
}
#else
{
float l9_5;
#if ((Tweak_N139)==1)
{
float l9_6=(((strokeThickness-Port_RangeMinA_N276)/(Port_RangeMaxA_N276-Port_RangeMinA_N276))*(Port_RangeMaxB_N276-Port_RangeMinB_N276))+Port_RangeMinB_N276;
float l9_7;
if (Port_RangeMaxB_N276>Port_RangeMinB_N276)
{
l9_7=clamp(l9_6,Port_RangeMinB_N276,Port_RangeMaxB_N276);
}
else
{
l9_7=clamp(l9_6,Port_RangeMaxB_N276,Port_RangeMinB_N276);
}
l9_5=l9_7;
}
#else
{
l9_5=Port_Default_N294;
}
#endif
l9_4=l9_5;
}
...
{
l9_3=Port_Default_N287;
}
l9_2=l9_3;
}
float l9_8=floor(float(xLeftPin));
bool l9_9=l9_8==0.0;
float l9_10;
if (l9_9)
{
l9_10=Port_Value0_N281;
}
else
{
float l9_11;
...
#if ((Tweak_N139)==0)
{
l9_12=(Port_Value_N288+0.001)-0.001;
}
#else
{
float l9_13;
#if ((Tweak_N139)==1)
{
float l9_14=(((strokeThickness-Port_RangeMinA_N295)/(Port_RangeMaxA_N295-Port_RangeMinA_N295))*(Port_RangeMaxB_N295-Port_RangeMinB_N295))+Port_RangeMinB_N295;
float l9_15;
if (Port_RangeMaxB_N295>Port_RangeMinB_N295)
{
l9_15=clamp(l9_14,Port_RangeMinB_N295,Port_RangeMaxB_N295);
}
else
{
l9_15=clamp(l9_14,Port_RangeMaxB_N295,Port_RangeMinB_N295);
}
l9_13=l9_15;
}
#else
{
l9_13=Port_Default_N296;
}
#endif
l9_12=l9_13;
}
...
{
l9_11=Port_Default_N281;
}
l9_10=l9_11;
}
float l9_16=l9_10-l9_2;
float l9_17=(((shapeWidthX-Port_RangeMinA_N268)/(Port_RangeMaxA_N268-Port_RangeMinA_N268))*l9_16)+l9_2;
float l9_18;
if (l9_10>l9_2)
{
l9_18=clamp(l9_17,l9_2,l9_10);
}
else
{
l9_18=clamp(l9_17,l9_10,l9_2);
}
float l9_19;
if (l9_9)
{
l9_19=Port_Value0_N282;
}
else
{
float l9_20;
if (l9_8==1.0)
{
l9_20=Port_Value1_N282;
}
else
{
l9_20=Port_Default_N282;
}
l9_19=l9_20;
}
float l9_21=xOffset+l9_19;
float l9_22;
#if ((Tweak_N139)==0)
{
l9_22=Port_Value0_N308;
}
#else
{
float l9_23;
...
if (l9_8==1.0)
{
float l9_26=(((strokeThickness-Port_RangeMinA_N303)/(Port_RangeMaxA_N303-Port_RangeMinA_N303))*(Port_RangeMaxB_N303-Port_RangeMinB_N303))+Port_RangeMinB_N303;
float l9_27;
if (Port_RangeMaxB_N303>Port_RangeMinB_N303)
{
l9_27=clamp(l9_26,Port_RangeMinB_N303,Port_RangeMaxB_N303);
}
else
{
l9_27=clamp(l9_26,Port_RangeMaxB_N303,Port_RangeMinB_N303);
}
l9_25=l9_27;
}
else
{
l9_25=Port_Default_N304;
}
l9_24=l9_25;
}
l9_23=l9_24;
...
#else
{
l9_23=Port_Default_N308;
}
#endif
l9_22=l9_23;
}
#endif
float l9_28=(1.0-l9_21)+l9_22;
float l9_29=l9_18+l9_28;
float l9_30=floor(float(yUpPin));
float l9_31;
if (l9_30==0.0)
{
l9_31=Port_Value0_N289;
}
else
{
float l9_32;
...
#if ((Tweak_N139)==0)
{
l9_33=(Port_Value_N288+0.001)-0.001;
}
#else
{
float l9_34;
#if ((Tweak_N139)==1)
{
float l9_35=(((strokeThickness-Port_RangeMinA_N299)/(Port_RangeMaxA_N299-Port_RangeMinA_N299))*(Port_RangeMaxB_N299-Port_RangeMinB_N299))+Port_RangeMinB_N299;
float l9_36;
if (Port_RangeMaxB_N299>Port_RangeMinB_N299)
{
l9_36=clamp(l9_35,Port_RangeMinB_N299,Port_RangeMaxB_N299);
}
else
{
l9_36=clamp(l9_35,Port_RangeMaxB_N299,Port_RangeMinB_N299);
}
l9_34=l9_36;
}
#else
{
l9_34=Port_Default_N297;
}
#endif
l9_33=l9_34;
}
...
{
l9_32=Port_Default_N289;
}
l9_31=l9_32;
}
float l9_37=floor(float(yDownPin));
bool l9_38=l9_37==0.0;
float l9_39;
if (l9_38)
{
l9_39=Port_Value0_N286;
}
else
{
float l9_40;
...
#if ((Tweak_N139)==0)
{
l9_41=(Port_Value_N288+0.001)-0.001;
}
#else
{
float l9_42;
#if ((Tweak_N139)==1)
{
float l9_43=(((strokeThickness-Port_RangeMinA_N300)/(Port_RangeMaxA_N300-Port_RangeMinA_N300))*(Port_RangeMaxB_N300-Port_RangeMinB_N300))+Port_RangeMinB_N300;
float l9_44;
if (Port_RangeMaxB_N300>Port_RangeMinB_N300)
{
l9_44=clamp(l9_43,Port_RangeMinB_N300,Port_RangeMaxB_N300);
}
else
{
l9_44=clamp(l9_43,Port_RangeMaxB_N300,Port_RangeMinB_N300);
}
l9_42=l9_44;
}
#else
{
l9_42=Port_Default_N298;
}
#endif
l9_41=l9_42;
}
...
{
l9_40=Port_Default_N286;
}
l9_39=l9_40;
}
float l9_45=l9_39-l9_31;
float l9_46=(((shapeHeightY-Port_RangeMinA_N277)/(Port_RangeMaxA_N277-Port_RangeMinA_N277))*l9_45)+l9_31;
float l9_47;
if (l9_39>l9_31)
{
l9_47=clamp(l9_46,l9_31,l9_39);
}
else
{
l9_47=clamp(l9_46,l9_39,l9_31);
}
float l9_48;
if (l9_38)
{
l9_48=Port_Value0_N293;
}
else
{
float l9_49;
if (l9_37==1.0)
{
l9_49=Port_Value1_N293;
}
else
{
l9_49=Port_Default_N293;
}
l9_48=l9_49;
}
float l9_50=yOffset+l9_48;
float l9_51;
#if ((Tweak_N139)==0)
{
l9_51=Port_Value0_N301;
}
#else
{
float l9_52;
...
if (l9_37==1.0)
{
float l9_55=(((strokeThickness-Port_RangeMinA_N305)/(Port_RangeMaxA_N305-Port_RangeMinA_N305))*(Port_RangeMaxB_N305-Port_RangeMinB_N305))+Port_RangeMinB_N305;
float l9_56;
if (Port_RangeMaxB_N305>Port_RangeMinB_N305)
{
l9_56=clamp(l9_55,Port_RangeMinB_N305,Port_RangeMaxB_N305);
}
else
{
l9_56=clamp(l9_55,Port_RangeMaxB_N305,Port_RangeMinB_N305);
}
l9_54=l9_56;
}
else
{
l9_54=Port_Default_N306;
}
l9_53=l9_54;
}
l9_52=l9_53;
...
#else
{
l9_52=Port_Default_N301;
}
#endif
l9_51=l9_52;
}
#endif
float l9_57=l9_50+l9_51;
float l9_58=l9_47+l9_57;
vec2 l9_59=((varPackedTex.xy*Port_Value0_N154.xy)+Port_Input2_N148)+vec2(l9_29,l9_58);
float l9_60=radians(Port_Value0_N132);
float l9_61=sin(l9_60);
float l9_62=cos(l9_60);
vec2 l9_63=l9_59-Port_Center_N092;
float l9_64=radians(1.0-(Port_Value0_N132+Port_Input1_N263));
float l9_65=sin(l9_64);
float l9_66=cos(l9_64);
vec2 l9_67=((vec2(dot(vec2(l9_62,l9_61),l9_63),dot(vec2(-l9_61,l9_62),l9_63))+Port_Center_N092)+vec2(Port_Value1_N097,Port_Value0_N131/Port_Input1_N160))-Port_Center_N094;
float l9_68=radians(shapeRotation);
float l9_69=sin(l9_68);
float l9_70=cos(l9_68);
vec2 l9_71=(vec2(dot(vec2(l9_66,l9_65),l9_67),dot(vec2(-l9_65,l9_66),l9_67))+Port_Center_N094)-Port_Center_N100;
vec2 l9_72=vec2(l9_70,l9_69);
vec2 l9_73=vec2(-l9_69,l9_70);
float l9_74=(((Port_Value0_N125-Port_RangeMinA_N138)/(Port_RangeMaxA_N138-Port_RangeMinA_N138))*(Port_RangeMaxB_N138-Port_RangeMinB_N138))+Port_RangeMinB_N138;
float l9_75;
if (Port_RangeMaxB_N138>Port_RangeMinB_N138)
{
l9_75=clamp(l9_74,Port_RangeMinB_N138,Port_RangeMaxB_N138);
}
else
{
l9_75=clamp(l9_74,Port_RangeMaxB_N138,Port_RangeMinB_N138);
}
vec2 l9_76=vec2(l9_75);
vec2 l9_77=abs((((((vec2(dot(l9_72,l9_71),dot(l9_73,l9_71))+Port_Center_N100)-Port_Center_N137)*l9_76)+Port_Center_N137)*vec2(Port_Input1_N003))+vec2(Port_Input1_N006));
float l9_78;
#if ((Tweak_N139)==0)
{
l9_78=Port_Value0_N122;
}
#else
{
float l9_79;
#if ((Tweak_N139)==1)
{
l9_79=strokeThickness;
}
#else
{
l9_79=Port_Default_N122;
}
#endif
l9_78=l9_79;
}
#endif
float l9_80=l9_78/Port_Input1_N056;
float l9_81=1.0-l9_80;
float l9_82=(((shapeWidthX-Port_RangeMinA_N018)/(Port_RangeMaxA_N018-Port_RangeMinA_N018))*(l9_81-Port_RangeMinB_N018))+Port_RangeMinB_N018;
float l9_83;
if (l9_81>Port_RangeMinB_N018)
{
l9_83=clamp(l9_82,Port_RangeMinB_N018,l9_81);
}
else
{
l9_83=clamp(l9_82,l9_81,Port_RangeMinB_N018);
}
float l9_84=(((shapeHeightY-Port_RangeMinA_N022)/(Port_RangeMaxA_N022-Port_RangeMinA_N022))*(l9_81-Port_RangeMinB_N022))+Port_RangeMinB_N022;
float l9_85;
if (l9_81>Port_RangeMinB_N022)
{
l9_85=clamp(l9_84,Port_RangeMinB_N022,l9_81);
}
else
{
l9_85=clamp(l9_84,l9_81,Port_RangeMinB_N022);
}
vec2 l9_86=vec2(l9_83,l9_85);
float l9_87=min(abs(shapeRoundness),l9_83);
float l9_88=min(l9_87,l9_85);
float l9_89=max(l9_88,Port_Input1_N012);
float l9_90=1.0-(length(max((l9_77-l9_86)+vec2(l9_89),Port_Input1_N031))/l9_89);
float l9_91=fwidth(l9_90);
float l9_92=Port_Value0_N125*Port_Input1_N127;
float l9_93=l9_90/((((l9_91-Port_RangeMinA_N135)/(Port_RangeMaxA_N135-Port_RangeMinA_N135))*(Port_RangeMaxB_N135-l9_92))+l9_92);
float l9_94=(((shapeWidthX-Port_RangeMinA_N019)/(Port_RangeMaxA_N019-Port_RangeMinA_N019))*(Port_RangeMaxB_N019-l9_80))+l9_80;
float l9_95;
if (Port_RangeMaxB_N019>l9_80)
{
l9_95=clamp(l9_94,l9_80,Port_RangeMaxB_N019);
}
else
{
l9_95=clamp(l9_94,Port_RangeMaxB_N019,l9_80);
}
float l9_96=(((shapeHeightY-Port_RangeMinA_N042)/(Port_RangeMaxA_N042-Port_RangeMinA_N042))*(Port_RangeMaxB_N042-l9_80))+l9_80;
float l9_97;
if (Port_RangeMaxB_N042>l9_80)
{
l9_97=clamp(l9_96,l9_80,Port_RangeMaxB_N042);
}
else
{
l9_97=clamp(l9_96,Port_RangeMaxB_N042,l9_80);
}
vec2 l9_98=vec2(l9_95,l9_97);
float l9_99=(((shapeRoundness-Port_RangeMinA_N057)/(Port_RangeMaxA_N057-Port_RangeMinA_N057))*(Port_RangeMaxB_N057-Port_RangeMinB_N057))+Port_RangeMinB_N057;
float l9_100;
if (Port_RangeMaxB_N057>Port_RangeMinB_N057)
{
l9_100=clamp(l9_99,Port_RangeMinB_N057,Port_RangeMaxB_N057);
}
else
{
l9_100=clamp(l9_99,Port_RangeMaxB_N057,Port_RangeMinB_N057);
}
float l9_101=l9_78-Port_RangeMinA_N101;
float l9_102=l9_100-Port_RangeMinB_N101;
float l9_103=((l9_101/(Port_RangeMaxA_N101-Port_RangeMinA_N101))*l9_102)+Port_RangeMinB_N101;
float l9_104=(((shapeRoundness-Port_RangeMinA_N047)/(Port_RangeMaxA_N047-Port_RangeMinA_N047))*(Port_RangeMaxB_N047-l9_103))+l9_103;
float l9_105;
if (Port_RangeMaxB_N047>l9_103)
{
l9_105=clamp(l9_104,l9_103,Port_RangeMaxB_N047);
}
else
{
l9_105=clamp(l9_104,Port_RangeMaxB_N047,l9_103);
}
float l9_106=abs(l9_105);
float l9_107=min(l9_106,l9_95);
float l9_108=min(l9_107,l9_97);
float l9_109=max(l9_108,Port_Input1_N026);
float l9_110=1.0-(length(max((l9_77-l9_98)+vec2(l9_109),Port_Input1_N035))/l9_109);
float l9_111=fwidth(l9_110);
float l9_112;
#if ((Tweak_N139)==0)
{
l9_112=Port_Value0_N064;
}
#else
{
float l9_113;
...
#else
{
l9_113=Port_Default_N064;
}
#endif
l9_112=l9_113;
}
#endif
vec4 l9_114=vec4(l9_0.x,l9_0.y,l9_0.z,vec4(0.0).w);
l9_114.w=((clamp(((shapeAlpha*(clamp(l9_93+0.001,Port_Input1_N017+0.001,Port_Input2_N017+0.001)-0.001))+((clamp(((clamp((1.0-l9_93)+0.001,Port_Input1_N264+0.001,Port_Input2_N264+0.001)-0.001)*(clamp((l9_110/((((l9_111-Port_RangeMinA_N133)/(Port_RangeMaxA_N133-Port_RangeMinA_N133))*(Port_RangeMaxB_N133-Port_Value0_N125))+Port_Value0_N125))+0.001,Port_Input1_N015+0.001,Port_Input2_N015+0.001)-0.001))+0.001,Port_Input1_N043+0.001,Port_Input2_N043+0.001)-0.001)*l9_112))+0.001,Port_Input1_N052+0.001,Port_Input2_N052+0.001)-0.001)*Port_Value0_N123)*(0.001-0.001);
vec2 l9_115=l9_59-Port_Center_N113;
vec2 l9_116=abs(((vec2(dot(l9_72,l9_115),dot(l9_73,l9_115))+Port_Center_N113)*vec2(Port_Input1_N089))+vec2(Port_Input1_N090));
float l9_117=max(l9_88,Port_Input1_N103);
float l9_118=1.0-(length(max((l9_116-l9_86)+vec2(l9_117),Port_Input1_N105))/l9_117);
float l9_119=fwidth(l9_118);
float l9_120=(l9_118/l9_119)+0.001;
float l9_121=clamp(l9_120,Port_Input1_N112+0.001,Port_Input2_N112+0.001)-0.001;
float l9_122=max(l9_108,Port_Input1_N077);
float l9_123=1.0-(length(max((l9_116-l9_98)+vec2(l9_122),Port_Input1_N079))/l9_122);
float l9_124=fwidth(l9_123);
float l9_125=(clamp(((1.0-(clamp(l9_120,Port_Input1_N265+0.001,Port_Input2_N265+0.001)-0.001))*(clamp((l9_123/l9_124)+0.001,Port_Input1_N098+0.001,Port_Input2_N098+0.001)-0.001))+0.001,Port_Input1_N116+0.001,Port_Input2_N116+0.001)-0.001)*l9_112;
float l9_126=l9_121*shapeAlpha;
float l9_127=((((((l9_125+l9_126)-max(l9_125,l9_126))+l9_126)-Port_RangeMinA_N143)/(Port_RangeMaxA_N143-Port_RangeMinA_N143))*((0.001-0.001)-(1.0-(0.001-0.001))))+(1.0-(0.001-0.001));
float l9_128;
#if ((0.001-0.001)>(1.0-(0.001-0.001)))
{
l9_128=clamp(l9_127,1.0-(0.001-0.001),0.001-0.001);
}
#else
{
l9_128=clamp(l9_127,0.001-0.001,1.0-(0.001-0.001));
}
#endif
vec4 l9_129=vec4(l9_128);
vec4 l9_130;
#if ((Tweak_N139)==0)
{
l9_130=Port_Value0_N140;
}
#else
{
vec4 l9_131;
...
#else
{
l9_131=Port_Default_N140;
}
#endif
l9_130=l9_131;
}
#endif
vec4 l9_132=mix(mix(mix(l9_114,vec4(Port_Input1_N259),vec4((0.001-0.001)*l9_121)),vec4(shapeColor.xyz,1.0),l9_129),l9_130,vec4(l9_125));
float l9_133=l9_132.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_133<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_133<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_136=clamp(l9_133*2.0,0.0,1.0);
}
#else
{
float l9_137;
...
{
l9_137=clamp(dot(l9_132.xyz,vec3(l9_133)),0.0,1.0);
}
#else
{
float l9_138;
...
{
l9_139=(1.0-dot(l9_132.xyz,vec3(0.33333001)))*l9_133;
}
#else
{
float l9_140;
...
{
l9_140=(1.0-clamp(dot(l9_132.xyz,vec3(1.0)),0.0,1.0))*l9_133;
}
#else
{
float l9_141;
...
{
l9_141=clamp(dot(l9_132.xyz,vec3(1.0)),0.0,1.0)*l9_133;
}
#else
{
float l9_142;
#if (sc_BlendMode_Add)
{
l9_142=clamp(dot(l9_132.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_143;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_143=clamp(dot(l9_132.xyz,vec3(1.0)),0.0,1.0)*l9_133;
}
#else
{
float l9_144;
...
{
l9_144=dot(l9_132.xyz,vec3(0.33333001))*l9_133;
}
#else
{
float l9_145;
#if (sc_BlendMode_Min)
{
l9_145=1.0-clamp(dot(l9_132.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_146;
#if (sc_BlendMode_Max)
{
l9_146=clamp(dot(l9_132.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_146=1.0;
...
#endif
l9_134=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_132.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_135);
}
#else
{
vec4 l9_147;
...
#if (sc_FramebufferFetch)
{
vec4 l9_150=sc_readFragData0_Platform();
vec4 l9_151;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_152=l9_150;
l9_152.x=l9_150.x+_sc_framebufferFetchMarker;
l9_151=l9_152;
}
#else
{
...
#else
{
vec2 l9_153=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
int l9_154;
#if (sc_ScreenTextureHasSwappedViews)
{
l9_154=1-sc_GetStereoViewIndex();
}
#else
{
l9_154=sc_GetStereoViewIndex();
}
#endif
l9_149=sc_SampleView(sc_ScreenTextureDims.xy,l9_153,sc_ScreenTextureLayout,l9_154,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_155;
...
{
vec4 l9_156=l9_149;
l9_156.x=l9_149.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_155=l9_156;
}
#else
{
...
#endif
vec3 l9_157=mix(l9_155.xyz,definedBlend(l9_155.xyz,l9_132.xyz).xyz,vec3(l9_133));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_159=vec4(mix(vec3(1.0),l9_132.xyz,vec3(l9_133)),l9_133);
}
#else
{
vec4 l9_160;
...
#endif
l9_160=vec4(l9_132.xyz*l9_161,l9_161);
}
#else
{
l9_160=l9_132;
...
vec4 l9_166=outputMotionVectorsIfNeeded(varPos,max(l9_165,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_168-0.0039215689)),min(1.0,l9_168+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_169=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
...
sc_writeFragData0(vec4(packValue(l9_170),packValue(l9_170),packValue(l9_170),packValue(l9_170)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_182=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
