...
//texture texture2DArray intensityTextureArrSC 2:27:2:17
//texture texture2DArray sc_ScreenTextureArrSC 2:30:2:22
//SG_REFLECTION_END
...
{
l9_138=sc_SampleView(sc_ScreenTextureDims.xy,l9_136,sc_ScreenTextureLayout,l9_137,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_138=sc_SampleView(sc_ScreenTextureDims.xy,l9_136,sc_ScreenTextureLayout,l9_137,0.0,sc_ScreenTexture);
}
#endif
l9_132=l9_138;
}
...
{
vec4 l9_140=l9_132;
l9_140.x=l9_132.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_139=l9_140;
}
#else
{
...
#endif
vec3 l9_141=mix(l9_139.xyz,definedBlend(l9_139.xyz,l9_115.xyz).xyz,vec3(l9_116));
vec4 l9_142=vec4(l9_141.x,l9_141.y,l9_141.z,vec4(0.0).w);
l9_142.w=1.0;
l9_131=l9_142;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_143=vec4(mix(vec3(1.0),l9_115.xyz,vec3(l9_116)),l9_116);
}
#else
{
vec4 l9_144;
...
#endif
l9_144=vec4(l9_115.xyz*l9_145,l9_145);
}
#else
{
l9_144=l9_115;
...
#endif
vec4 l9_146=outputMotionVectorsIfNeeded(varPos,max(l9_117,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_148-0.0039215689)),min(1.0,l9_148+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_149=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_149).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_150=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_149).xy);
float l9_151=packValue(l9_150);
int l9_158=int(l9_147.w*255.0);
float l9_159=packValue(l9_158);
sc_writeFragData0(vec4(packValue(l9_150),packValue(l9_150),packValue(l9_150),packValue(l9_150)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_162=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_162).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_167==0)
{
l9_170=texture(sc_OITAlpha0,l9_162);
l9_169=texture(sc_OITDepthLow0,l9_162);
l9_168=texture(sc_OITDepthHigh0,l9_162);
}
else
{
l9_170=vec4(0.0);
...
if (l9_167==1)
{
l9_173=texture(sc_OITAlpha1,l9_162);
l9_172=texture(sc_OITDepthLow1,l9_162);
l9_171=texture(sc_OITDepthHigh1,l9_162);
}
else
{
l9_173=l9_170;
...
mediump vec4 l9_188=texture(sc_OITFilteredDepthBoundsTexture,l9_162);
