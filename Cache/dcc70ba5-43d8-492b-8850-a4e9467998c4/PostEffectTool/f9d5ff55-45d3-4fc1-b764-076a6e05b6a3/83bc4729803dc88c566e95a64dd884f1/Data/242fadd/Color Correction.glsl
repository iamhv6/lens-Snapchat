...
#endif
vec4 l9_3=sc_SampleTextureBiasOrLevel(screenTexDims.xy,screenTexLayout,l9_2,l9_1,(int(SC_USE_UV_TRANSFORM_screenTex)!=0),screenTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTex,SC_SOFTWARE_WRAP_MODE_V_screenTex),(int(SC_USE_UV_MIN_MAX_screenTex)!=0),screenTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_screenTex)!=0),screenTexBorderColor,0.0,screenTex);
float l9_4=l9_3.z*15.0;
vec2 l9_5=clamp(vec2(floor(l9_4))+vec2(0.0,1.0),vec2(0.0),vec2(15.0));
vec3 l9_6=((l9_3.xxy*vec3(0.05859375,0.05859375,0.9375))+vec3(l9_5*0.0625,0.0))+vec3(0.001953125,0.001953125,0.03125);
vec4 l9_7=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_6.xz,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
vec4 l9_8=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_6.yz,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
vec4 l9_9=vec4(mix(l9_3.xyz,vec4(mix(l9_7.xyz,l9_8.xyz,vec3(l9_4-l9_5.x)),0.0).xyz*baseColor.xyz,vec3(baseColor.w*1.0)),1.0);
...
{
l9_13=clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_14;
...
{
l9_15=(1.0-dot(l9_9.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_16;
...
{
l9_16=(1.0-clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_17;
...
{
l9_17=clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_18;
#if (sc_BlendMode_Add)
{
l9_18=clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_19;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_19=clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_20;
...
{
l9_20=dot(l9_9.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_21;
#if (sc_BlendMode_Min)
{
l9_21=1.0-clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_22;
#if (sc_BlendMode_Max)
{
l9_22=clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_22=1.0;
...
#endif
l9_10=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_9.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_11);
}
#else
{
vec4 l9_23;
...
#if (sc_FramebufferFetch)
{
mediump vec4 l9_26=sc_readFragData0_Platform();
vec4 l9_27;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_28=l9_26;
l9_28.x=l9_26.x+_sc_framebufferFetchMarker;
l9_27=l9_28;
}
#else
{
...
#else
{
vec2 l9_29=sc_ScreenCoordsGlobalToView(l9_0);
int l9_30;
...
#endif
l9_25=sc_SampleView(sc_ScreenTextureDims.xy,l9_29,sc_ScreenTextureLayout,l9_30,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_31;
...
{
vec4 l9_32=l9_25;
l9_32.x=l9_25.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_31=l9_32;
}
#else
{
...
#endif
vec3 l9_33=definedBlend(l9_31.xyz,l9_9.xyz);
...
#endif
vec4 l9_37=outputMotionVectorsIfNeeded(varPos,max(l9_10,vec4(0.0)));
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_40).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_41=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_40).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_53).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_64==0)
{
l9_67=texture2D(sc_OITAlpha0,l9_53);
l9_66=texture2D(sc_OITDepthLow0,l9_53);
l9_65=texture2D(sc_OITDepthHigh0,l9_53);
}
else
{
l9_67=l9_60;
...
if (l9_64==1)
{
l9_63=texture2D(sc_OITAlpha1,l9_53);
l9_62=texture2D(sc_OITDepthLow1,l9_53);
l9_61=texture2D(sc_OITDepthHigh1,l9_53);
}
else
{
l9_63=l9_67;
...
if (any(notEqual(l9_61,vec4(0.0)))||any(notEqual(l9_62,vec4(0.0))))
{
int l9_68[8];
l9_68[0]=l9_54[0];
l9_68[1]=l9_54[1];
...
l9_68[6]=l9_54[6];
l9_68[7]=l9_54[7];
unpackValues(l9_61.w,l9_64,l9_68);
unpackValues(l9_61.z,l9_64,l9_68);
unpackValues(l9_61.y,l9_64,l9_68);
unpackValues(l9_61.x,l9_64,l9_68);
unpackValues(l9_62.w,l9_64,l9_68);
unpackValues(l9_62.z,l9_64,l9_68);
unpackValues(l9_62.y,l9_64,l9_68);
unpackValues(l9_62.x,l9_64,l9_68);
int l9_77[8];
l9_77[0]=l9_55[0];
l9_77[1]=l9_55[1];
l9_77[2]=l9_55[2];
...
l9_77[6]=l9_55[6];
l9_77[7]=l9_55[7];
unpackValues(l9_63.w,l9_64,l9_77);
unpackValues(l9_63.z,l9_64,l9_77);
unpackValues(l9_63.y,l9_64,l9_77);
unpackValues(l9_63.x,l9_64,l9_77);
}
l9_60=l9_63;
l9_59=l9_62;
l9_58=l9_61;
...
mediump vec4 l9_82=texture2D(sc_OITFilteredDepthBoundsTexture,l9_53);
vec2 l9_83=l9_82.xy;
int l9_84;
#if (sc_SkinBonesCount>0)
{
l9_84=encodeDepth(((1.0-l9_82.x)*1000.0)+getDepthOrderingEpsilon(),l9_83);
}
#else
{
l9_84=0;
...
#endif
int l9_85=encodeDepth(viewSpaceDepth(),l9_83);
vec4 l9_86;
l9_86=l9_38*l9_38.w;
vec4 l9_87;
int l9_88=0;
...
if (l9_88<8)
{
int l9_89=l9_54[l9_88];
int l9_90=l9_85-l9_84;
bool l9_91=l9_89<l9_90;
bool l9_92;
if (l9_91)
{
l9_92=l9_54[l9_88]>0;
...
if (l9_92)
{
vec3 l9_93=l9_86.xyz*(1.0-(float(l9_55[l9_88])/255.0));
l9_87=vec4(l9_93.x,l9_93.y,l9_93.z,l9_86.w);
}
else
{
l9_87=l9_86;
