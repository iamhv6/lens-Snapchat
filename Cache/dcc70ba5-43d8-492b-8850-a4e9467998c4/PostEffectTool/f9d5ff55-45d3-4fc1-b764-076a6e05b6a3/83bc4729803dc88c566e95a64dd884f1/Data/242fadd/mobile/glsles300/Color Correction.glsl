...
//sampler sampler sc_OITCommonSampler 2:23
//sampler sampler sc_ScreenTextureSmpSC 2:25
//sampler sampler screenTexSmpSC 2:28
//texture texture2D baseTex 2:0:2:18
//texture texture2D intensityTexture 2:1:2:19
//texture texture2D sc_OITAlpha0 2:5:2:23
//texture texture2D sc_OITAlpha1 2:6:2:23
//texture texture2D sc_OITDepthHigh0 2:7:2:23
//texture texture2D sc_OITDepthHigh1 2:8:2:23
//texture texture2D sc_OITDepthLow0 2:9:2:23
//texture texture2D sc_OITDepthLow1 2:10:2:23
//texture texture2D sc_OITFilteredDepthBoundsTexture 2:11:2:23
//texture texture2D sc_OITFrontDepthTexture 2:12:2:23
//texture texture2D sc_ScreenTexture 2:14:2:25
//texture texture2D screenTex 2:17:2:28
//texture texture2DArray baseTexArrSC 2:29:2:18
//texture texture2DArray intensityTextureArrSC 2:30:2:19
//texture texture2DArray sc_ScreenTextureArrSC 2:34:2:25
//texture texture2DArray screenTexArrSC 2:35:2:28
//SG_REFLECTION_END
...
uniform mediump sampler2DArray screenTexArrSC;
...
vec4 l9_2;
#if (screenTexLayout==2)
{
l9_2=sc_SampleTextureBiasOrLevel(screenTexDims.xy,screenTexLayout,screenTexGetStereoViewIndex(),l9_1,(int(SC_USE_UV_TRANSFORM_screenTex)!=0),screenTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTex,SC_SOFTWARE_WRAP_MODE_V_screenTex),(int(SC_USE_UV_MIN_MAX_screenTex)!=0),screenTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_screenTex)!=0),screenTexBorderColor,0.0,screenTexArrSC);
}
#else
{
...
#endif
float l9_3=l9_2.z*15.0;
vec2 l9_4=clamp(vec2(floor(l9_3))+vec2(0.0,1.0),vec2(0.0),vec2(15.0));
vec3 l9_5=((l9_2.xxy*vec3(0.05859375,0.05859375,0.9375))+vec3(l9_4*0.0625,0.0))+vec3(0.001953125,0.001953125,0.03125);
vec4 l9_6;
#if (baseTexLayout==2)
{
l9_6=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_5.xz,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_6=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_5.xz,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
#if (baseTexLayout==2)
{
l9_7=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_5.yz,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_7=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_5.yz,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
#endif
vec4 l9_8=vec4(mix(l9_2.xyz,vec4(mix(l9_6.xyz,l9_7.xyz,vec3(l9_3-l9_4.x)),0.0).xyz*baseColor.xyz,vec3(baseColor.w*1.0)),1.0);
...
{
l9_12=clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_13;
...
{
l9_14=(1.0-dot(l9_8.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_15;
...
{
l9_15=(1.0-clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_16;
...
{
l9_16=clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_17;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_18=clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_19;
...
{
l9_19=dot(l9_8.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_20;
...
#if (sc_FramebufferFetch)
{
mediump vec4 l9_25=sc_readFragData0_Platform();
vec4 l9_26;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_27=l9_25;
l9_27.x=l9_25.x+_sc_framebufferFetchMarker;
l9_26=l9_27;
}
#else
{
...
#else
{
vec2 l9_28=sc_ScreenCoordsGlobalToView(l9_0);
int l9_29;
...
{
l9_30=sc_SampleView(sc_ScreenTextureDims.xy,l9_28,sc_ScreenTextureLayout,l9_29,0.0,sc_ScreenTextureArrSC);
}
#else
{
l9_30=sc_SampleView(sc_ScreenTextureDims.xy,l9_28,sc_ScreenTextureLayout,l9_29,0.0,sc_ScreenTexture);
}
#endif
l9_24=l9_30;
}
...
{
vec4 l9_32=l9_24;
l9_32.x=l9_24.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_31=l9_32;
}
#else
{
...
#endif
vec3 l9_33=definedBlend(l9_31.xyz,l9_8.xyz);
...
#endif
vec4 l9_37=outputMotionVectorsIfNeeded(varPos,max(l9_9,vec4(0.0)));
vec4 l9_38=clamp(l9_37,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_39=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_39-0.0039215689)),min(1.0,l9_39+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_40=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_40).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_41=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_40).xy);
float l9_42=packValue(l9_41);
int l9_49=int(l9_38.w*255.0);
float l9_50=packValue(l9_49);
sc_writeFragData0(vec4(packValue(l9_41),packValue(l9_41),packValue(l9_41),packValue(l9_41)));
sc_writeFragData1(vec4(l9_42,packValue(l9_41),packValue(l9_41),packValue(l9_41)));
sc_writeFragData2(vec4(l9_50,packValue(l9_49),packValue(l9_49),packValue(l9_49)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_53=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_58==0)
{
l9_61=texture(sc_OITAlpha0,l9_53);
l9_60=texture(sc_OITDepthLow0,l9_53);
l9_59=texture(sc_OITDepthHigh0,l9_53);
}
else
{
l9_61=vec4(0.0);
...
if (l9_58==1)
{
l9_64=texture(sc_OITAlpha1,l9_53);
l9_63=texture(sc_OITDepthLow1,l9_53);
l9_62=texture(sc_OITDepthHigh1,l9_53);
}
else
{
l9_64=l9_61;
...
if (any(notEqual(l9_62,vec4(0.0)))||any(notEqual(l9_63,vec4(0.0))))
{
int l9_65[8]=l9_54;
unpackValues(l9_62.w,l9_58,l9_65);
unpackValues(l9_62.z,l9_58,l9_65);
unpackValues(l9_62.y,l9_58,l9_65);
unpackValues(l9_62.x,l9_58,l9_65);
unpackValues(l9_63.w,l9_58,l9_65);
unpackValues(l9_63.z,l9_58,l9_65);
unpackValues(l9_63.y,l9_58,l9_65);
unpackValues(l9_63.x,l9_58,l9_65);
int l9_74[8]=l9_55;
unpackValues(l9_64.w,l9_58,l9_74);
unpackValues(l9_64.z,l9_58,l9_74);
unpackValues(l9_64.y,l9_58,l9_74);
unpackValues(l9_64.x,l9_58,l9_74);
}
l9_58++;
continue;
}
...
mediump vec4 l9_79=texture(sc_OITFilteredDepthBoundsTexture,l9_53);
vec2 l9_80=l9_79.xy;
int l9_81;
#if (sc_SkinBonesCount>0)
{
l9_81=encodeDepth(((1.0-l9_79.x)*1000.0)+getDepthOrderingEpsilon(),l9_80);
}
#else
{
l9_81=0;
...
#endif
int l9_82=encodeDepth(viewSpaceDepth(),l9_80);
vec4 l9_83;
l9_83=l9_38*l9_38.w;
vec4 l9_84;
int l9_85=0;
...
if (l9_85<8)
{
int l9_86=l9_54[l9_85];
int l9_87=l9_82-l9_81;
bool l9_88=l9_86<l9_87;
bool l9_89;
if (l9_88)
{
l9_89=l9_54[l9_85]>0;
...
if (l9_89)
{
vec3 l9_90=l9_83.xyz*(1.0-(float(l9_55[l9_85])/255.0));
l9_84=vec4(l9_90.x,l9_90.y,l9_90.z,l9_83.w);
}
else
{
l9_84=l9_83;
...
sc_writeFragData0(l9_38);
}
#endif
}
#else
{
sc_writeFragData0(l9_37);
}
#endif
}
#endif
